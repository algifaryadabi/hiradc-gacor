...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 11, 2026 at 03:37 AM
...
CREATE TABLE `business_processes` (
  ...
  `nama_probis` varchar(255) NOT NULL,
  `kode_probis` varchar(10) NOT NULL,
...
CREATE TABLE `can_create_documents` (
  `id_create_documents` tinyint(4) NOT NULL,
...
CREATE TABLE `documents` (
  ...
  `id_direktorat` int(10) UNSIGNED DEFAULT NULL,
  `id_dept` int(10) UNSIGNED DEFAULT NULL,
  `id_unit` int(10) UNSIGNED DEFAULT NULL,
  `id_seksi` int(10) UNSIGNED DEFAULT NULL,
  `kategori` enum('K3','KO','Lingkungan','Keamanan') NOT NULL DEFAULT 'K3',
  `judul_dokumen` varchar(255) DEFAULT NULL,
  `status` varchar(255) NOT NULL DEFAULT 'draft',
  `status_she` varchar(100) DEFAULT NULL,
  `she_current_approver_id` bigint(20) UNSIGNED DEFAULT NULL,
  `she_reviewer_id` bigint(20) UNSIGNED DEFAULT NULL,
  `she_verificator_id` bigint(20) UNSIGNED DEFAULT NULL,
  `she_approved_at` timestamp NULL DEFAULT NULL,
  `status_security` varchar(100) DEFAULT NULL,
  `security_current_approver_id` bigint(20) UNSIGNED DEFAULT NULL,
  `security_reviewer_id` bigint(20) UNSIGNED DEFAULT NULL,
  `security_verificator_id` bigint(20) UNSIGNED DEFAULT NULL,
  `security_approved_at` timestamp NULL DEFAULT NULL,
  `level2_status` varchar(255) DEFAULT NULL,
  `level2_reviewer_id` bigint(20) UNSIGNED DEFAULT NULL,
  `level2_approver_id` bigint(20) UNSIGNED DEFAULT NULL,
  `level2_assignment_date` timestamp NULL DEFAULT NULL,
  `compliance_checklist` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `compliance_checklist_she` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`compliance_checklist_she`)),
  `compliance_checklist_security` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`compliance_checklist_security`)),
  `current_level` int(11) NOT NULL DEFAULT 0,
  `kolom2_proses` varchar(255) DEFAULT NULL,
  `kolom2_kegiatan` text DEFAULT NULL,
  `kolom3_lokasi` varchar(255) DEFAULT NULL,
  `kolom5_kondisi` varchar(255) DEFAULT NULL,
  `kolom6_bahaya` text DEFAULT NULL,
  `kolom9_risiko` text DEFAULT NULL,
  `kolom10_pengendalian` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `kolom11_existing` text DEFAULT NULL,
  `kolom12_kemungkinan` int(11) DEFAULT NULL,
  `kolom13_konsekuensi` int(11) DEFAULT NULL,
  `kolom14_score` int(11) DEFAULT NULL,
  `kolom14_level` varchar(255) DEFAULT NULL,
  `kolom15_regulasi` text DEFAULT NULL,
  `kolom16_aspek` varchar(255) DEFAULT NULL,
  `kolom17_risiko` text DEFAULT NULL,
  `kolom17_peluang` text DEFAULT NULL,
  `residual_kemungkinan` int(11) DEFAULT NULL,
  `residual_konsekuensi` int(11) DEFAULT NULL,
  `residual_score` int(11) DEFAULT NULL,
  `residual_level` varchar(255) DEFAULT NULL,
...
(22, 45, NULL, NULL, NULL, 2, 3, 11, 40, 'Keamanan', 'Identifikasi dan Penetapan Mitigasi Risiko Pengamanan', 'pending_level1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'Production', 'produksi semen', 'sdfghjkl', 'Emergency', '{\"type\":\"\",\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'dfghjk', '{\"hierarchy\":[\"Eliminasi\"],\"new_controls\":[]}', '1. Eliminasi:\r\n   fghjn', 2, 2, 4, NULL, 'fghjk', 'TP', 'fghj', 'fghjk', 1, 1, 0, NULL, NULL, '2026-02-04 03:37:53', '2026-02-04 03:37:53'),
(26, 45, NULL, NULL, NULL, 2, 3, 11, 40, 'KO', 'Identifikasi dan Penetapan Mitigasi Risiko K3, KO, Aspek Lingkungan', 'published', 'published', NULL, 146, 585, '2026-02-04 09:00:26', 'none', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '{\"format\":{\"status\":\"OK\",\"note\":\"\"},\"numbering\":{\"status\":\"OK\",\"note\":\"\"},\"revision\":{\"status\":\"OK\",\"note\":\"\"},\"approval\":{\"status\":\"OK\",\"note\":\"\"},\"identification_coverage\":{\"status\":\"OK\",\"note\":\"\"},\"condition_coverage\":{\"status\":\"OK\",\"note\":\"\"},\"mitigation\":{\"status\":\"OK\",\"note\":\"\"}}', NULL, 3, 'Production', 'gaje', 'vghjk', 'Non-Rutin', '{\"type\":\"\",\"kategori\":\"KO\",\"details\":[\"Bahaya Fisika\"],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'ghjk', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 2, 3, 6, NULL, 'uu 12', 'TP', 'ghjkl', 'ghjk', 1, 1, 0, NULL, '2026-02-05 01:38:04', '2026-02-04 07:00:42', '2026-02-05 01:38:04'),
(27, 45, NULL, NULL, NULL, 2, 3, 11, 40, 'KO', 'Identifikasi dan Penetapan Mitigasi Risiko K3, KO, Aspek Lingkungan', 'pending_level1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'Production', 'uiuiu', 'di pabrik', 'Rutin', '{\"type\":\"\",\"kategori\":\"KO\",\"details\":[\"Bahaya Fisika\",\"Bahaya Kimia\"],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'hjk.', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 2, 3, 6, NULL, 'uu 12', 'TP', 'vbhjkl', 'fghjkl', 1, 1, 0, NULL, NULL, '2026-02-04 07:23:21', '2026-02-04 07:23:21'),
(30, 45, NULL, NULL, NULL, 2, 3, 11, 40, 'Keamanan', 'Identifikasi dan Penetapan Mitigasi Risiko Pengamanan', 'pending_level2', 'none', NULL, NULL, NULL, NULL, 'pending_head', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 'Production', 'makanan', 'di bumi', 'Emergency', '{\"type\":\"\",\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'gyuio', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 5, 5, 25, NULL, 'uu 12', 'TP', 'ghjuikol', 'tyuio', 1, 1, 0, NULL, NULL, '2026-02-05 03:15:33', '2026-02-05 03:32:54'),
(31, 45, NULL, NULL, NULL, 2, 3, 11, 40, 'Keamanan', 'Identifikasi dan Penetapan Mitigasi Risiko Pengamanan', 'pending_level1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'Production', 'dimsum wuenakk', 'pasbar', 'Emergency', '{\"type\":\"\",\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'aman semua', '{\"hierarchy\":[\"Eliminasi\",\"Substitusi\"],\"new_controls\":[]}', '1. Eliminasi:\r\n   eliminasi aja dikit\r\n\r\n2. Substitusi:\r\n   gas ajaa', 2, 2, 4, NULL, 'uu 15', 'TP', 'aman', 'masukk', 1, 1, 0, NULL, NULL, '2026-02-05 03:30:33', '2026-02-05 03:30:33'),
(32, 45, NULL, NULL, NULL, 2, 3, 11, 40, 'K3', 'Identifikasi dan Penetapan Mitigasi Risiko K3, KO, Aspek Lingkungan', 'pending_level1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'Production', 'ss', 'ss', 'Non-Rutin', '{\"type\":\"\",\"kategori\":\"K3\",\"details\":[\"Bahaya Fisika\",\"Bahaya Kimia\",\"Bahaya dari Prilaku\"],\"manual\":\"ss\",\"aspects\":[],\"threats\":[]}', 'ss', '{\"hierarchy\":[\"Eliminasi\",\"Substitusi\"],\"new_controls\":[]}', '1. Eliminasi:\r\n   s\r\n\r\n2. Substitusi:\r\n   s', 2, 5, 10, NULL, 'ss', 'TP', 'ss', 'ssss', 1, 1, 0, NULL, NULL, '2026-02-05 07:57:18', '2026-02-05 07:57:18'),
(33, 45, NULL, NULL, NULL, 2, 3, 11, 40, 'K3', 'Identifikasi dan Penetapan Mitigasi Risiko K3, KO, Aspek Lingkungan', 'pending_level1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'Production', 'ss', 'ss', 'Emergency', '{\"type\":\"\",\"kategori\":\"K3\",\"details\":[\"Bahaya Fisika\",\"Bahaya Kimia\",\"Bahaya Psikologis\"],\"manual\":\"ss\",\"aspects\":[],\"threats\":[]}', 'ss', '{\"hierarchy\":[\"Eliminasi\",\"Substitusi\"],\"new_controls\":[]}', '1. Eliminasi:\r\n   s\r\n\r\n2. Substitusi:\r\n   s', 4, 2, 8, NULL, 'ss', 'TP', 'ss', 'ss', 1, 1, 0, NULL, NULL, '2026-02-05 08:31:09', '2026-02-05 08:31:09'),
(34, 45, NULL, NULL, NULL, 2, 3, 11, 40, 'K3', 'Identifikasi dan Penetapan Mitigasi Risiko K3, KO, Aspek Lingkungan', 'pending_level1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'Production', 'ds', 'dssd', 'Rutin', '{\"type\":\"\",\"kategori\":\"K3\",\"details\":[\"Bahaya Fisika\",\"Bahaya Kimia\"],\"manual\":\"ds\",\"aspects\":[],\"threats\":[]}', 'ss', '{\"hierarchy\":[\"Eliminasi\",\"Substitusi\"],\"new_controls\":[]}', '1. Eliminasi:\r\n   ds\r\n\r\n2. Substitusi:\r\n   ds', 2, 5, 10, NULL, NULL, 'TP', NULL, NULL, 1, 1, 0, NULL, NULL, '2026-02-05 08:32:50', '2026-02-05 08:32:50'),
(35, 45, NULL, NULL, NULL, 2, 3, 11, 40, 'KO', 'Identifikasi dan Penetapan Mitigasi Risiko K3, KO, Aspek Lingkungan', 'pending_level1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'Production', 'membaca', 'bangunan', 'Emergency', '{\"type\":\"\",\"kategori\":\"KO\",\"details\":[\"Bahaya Fisika\"],\"manual\":\"ayokla capek\",\"aspects\":[],\"threats\":[]}', 'adad', '{\"hierarchy\":[\"Eliminasi\",\"Substitusi\"],\"new_controls\":[]}', '1. Eliminasi:\r\n   xa\r\n\r\n2. Substitusi:\r\n   zx', 5, 4, 20, NULL, 'xz', 'TP', 'zx', 'zx', 1, 1, 0, NULL, NULL, '2026-02-05 08:35:49', '2026-02-05 08:35:49'),
(36, 15, NULL, NULL, NULL, 2, 9, 48, 23, 'Keamanan', 'Identifikasi dan Penetapan Mitigasi Risiko Pengamanan', 'pending_level1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'Production', 'buat bahan bangunan', 'pabrik', 'Emergency', '{\"type\":\"\",\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'pekerja pabrik terpeleset', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 3, 2, 6, NULL, 'uu 12', 'TP', 'produksi lebih efisien', 'pekerja pabrik menjadi aman dan dapat bekerja sepenuh hati', 1, 1, 0, NULL, NULL, '2026-02-06 01:41:48', '2026-02-06 01:41:48'),
(37, 15, NULL, NULL, NULL, 2, 9, 48, 23, 'Keamanan', 'Identifikasi dan Penetapan Mitigasi Risiko Pengamanan', 'pending_level1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'Maintenance Productive Asset', 'yuyuy', 'iiiii', 'Emergency', '{\"type\":\"\",\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'wowo', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 5, 2, 10, NULL, 'asaii', 'TP', 'ayokkla', 'walawee', 1, 1, 0, NULL, NULL, '2026-02-06 01:49:46', '2026-02-06 01:49:46'),
(40, 15, NULL, NULL, NULL, 2, 9, 48, 23, 'Keamanan', 'Identifikasi dan Penetapan Mitigasi Risiko Pengamanan', 'revision', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Maintenance Productive Asset', 'membaca', 'tanah', 'Emergency', '{\"type\":\"\",\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'ghjk', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 3, 5, 15, NULL, 'uu 12', 'TP', 'uiui', 'yuio', 1, 1, 0, NULL, NULL, '2026-02-06 02:47:28', '2026-02-09 06:44:03'),
(44, 15, NULL, NULL, NULL, 2, 9, 48, 23, 'K3', 'Identifikasi dan Penetapan Mitigasi Risiko K3, KO, Aspek Lingkungan', 'published', 'published', NULL, 146, 585, '2026-02-08 01:51:50', 'none', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '{\"format\":{\"status\":\"OK\",\"note\":\"\"},\"numbering\":{\"status\":\"OK\",\"note\":\"\"},\"revision\":{\"status\":\"OK\",\"note\":\"\"},\"approval\":{\"status\":\"OK\",\"note\":\"\"},\"identification_coverage\":{\"status\":\"OK\",\"note\":\"\"},\"condition_coverage\":{\"status\":\"OK\",\"note\":\"\"},\"mitigation\":{\"status\":\"OK\",\"note\":\"\"}}', NULL, 4, 'Maintenance Productive Asset', 'pembuatan pipa', 'di pabrik', 'Non-Rutin', '{\"type\":\"\",\"kategori\":\"K3\",\"details\":[\"Bahaya Fisika\",\"Bahaya Kimia\"],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'qwqw', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 5, 5, 25, NULL, '1212', 'TP', 'qwertyuio', 'qwertyuiop', 1, 1, 0, NULL, '2026-02-08 03:09:56', '2026-02-08 01:27:50', '2026-02-08 03:09:56'),
(45, 15, NULL, NULL, NULL, 2, 9, 48, 23, 'K3', 'Identifikasi dan Penetapan Mitigasi Risiko K3, KO, Aspek Lingkungan', 'published', 'published', NULL, 146, 585, '2026-02-08 14:31:04', 'none', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '{\"format\":{\"status\":\"OK\",\"note\":\"\"},\"numbering\":{\"status\":\"OK\",\"note\":\"\"},\"revision\":{\"status\":\"OK\",\"note\":\"\"},\"approval\":{\"status\":\"OK\",\"note\":\"\"},\"identification_coverage\":{\"status\":\"OK\",\"note\":\"\"},\"condition_coverage\":{\"status\":\"OK\",\"note\":\"\"},\"mitigation\":{\"status\":\"OK\",\"note\":\"\"}}', NULL, 4, 'Maintenance Productive Asset', 'upin ipin', 'diklt', 'Non-Rutin', '{\"type\":\"\",\"kategori\":\"K3\",\"details\":[\"Bahaya Fisika\",\"Bahaya Kimia\",\"Bahaya Psikologis\"],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'where', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 3, 2, 6, NULL, 'uu 13', 'TP', 'why', 'what', 1, 1, 0, NULL, '2026-02-08 14:32:38', '2026-02-08 14:23:55', '2026-02-08 14:32:38'),
(46, 15, NULL, NULL, NULL, 2, 9, 48, 23, 'Keamanan', 'Identifikasi dan Penetapan Mitigasi Risiko Pengamanan', 'pending_level3_ready', 'none', NULL, NULL, NULL, NULL, 'approved', NULL, 519, 1018, '2026-02-09 07:04:08', NULL, NULL, NULL, NULL, NULL, NULL, '{\"format\":{\"status\":\"OK\",\"note\":\"\"},\"numbering\":{\"status\":\"OK\",\"note\":\"\"},\"revision\":{\"status\":\"OK\",\"note\":\"\"},\"approval\":{\"status\":\"OK\",\"note\":\"\"},\"identification_coverage\":{\"status\":\"OK\",\"note\":\"\"},\"condition_coverage\":{\"status\":\"OK\",\"note\":\"\"},\"mitigation\":{\"status\":\"OK\",\"note\":\"\"}}', 2, 'Maintenance Productive Asset', 'wertyuiop', 'workshop', 'Emergency', '{\"type\":\"\",\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'rtyuio', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 2, 3, 6, NULL, 'uu 13', 'TP', 'asdfghjkl', 'qwertyuio', 1, 1, 0, NULL, NULL, '2026-02-08 16:20:38', '2026-02-09 07:04:08'),
(47, 15, NULL, NULL, NULL, 2, 9, 48, 23, 'K3', 'Identifikasi dan Penetapan Mitigasi Risiko K3, KO, Aspek Lingkungan', 'revision', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Maintenance Productive Asset', 'mercon', 'kadai', 'Rutin', '{\"type\":\"\",\"kategori\":\"K3\",\"details\":[\"Bahaya Fisika\",\"Bahaya Kimia\",\"Bahaya dari Prilaku\"],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'harimau', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 3, 5, 15, NULL, 'uu 18', 'TP', 'kucing', 'kasih paham boss', 1, 1, 0, NULL, NULL, '2026-02-09 06:55:13', '2026-02-09 06:57:30'),
(48, 15, NULL, NULL, NULL, 2, 9, 48, 23, 'Lingkungan', 'Identifikasi dan Penetapan Mitigasi Risiko K3, KO, Aspek Lingkungan', 'revision', 'revision', NULL, 146, 585, NULL, 'none', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '{\"format\":{\"status\":\"OK\",\"note\":\"\"},\"numbering\":{\"status\":\"OK\",\"note\":\"\"},\"revision\":{\"status\":\"OK\",\"note\":\"\"},\"approval\":{\"status\":\"OK\",\"note\":\"\"},\"identification_coverage\":{\"status\":\"OK\",\"note\":\"\"},\"condition_coverage\":{\"status\":\"OK\",\"note\":\"\"},\"mitigation\":{\"status\":\"OK\",\"note\":\"\"}}', NULL, 2, 'Maintenance Productive Asset', 'lamang tapai', 'usm', 'Normal', '{\"type\":\"\",\"kategori\":\"Lingkungan\",\"details\":[],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'kotor', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 4, 5, 20, NULL, 'uu 13', 'P', 'sdfg', 'qwertyuio', 1, 1, 1, NULL, NULL, '2026-02-10 04:00:32', '2026-02-10 07:57:29'),
(49, 15, NULL, NULL, NULL, 2, 9, 48, 23, 'Keamanan', 'Identifikasi dan Penetapan Mitigasi Risiko Pengamanan', 'pending_level1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'Maintenance Productive Asset', 'etek', 'pasar', 'Emergency', '{\"type\":\"\",\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'pasasr raya', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 4, 2, 8, NULL, 'uu 23', 'TP', 'jika', 'inovasi', 1, 1, 0, NULL, NULL, '2026-02-10 07:00:28', '2026-02-10 07:00:28');
...
CREATE TABLE `document_details` (
  ...
  `kolom2_proses` varchar(255) DEFAULT NULL,
  `kolom2_kegiatan` varchar(255) NOT NULL,
  `kolom3_lokasi` varchar(255) NOT NULL,
  `kolom4_pihak` varchar(255) DEFAULT NULL,
  `kolom5_kondisi` varchar(255) NOT NULL,
  `kolom6_bahaya` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `kolom7_aspek_lingkungan` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`kolom7_aspek_lingkungan`)),
  `kolom8_ancaman` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`kolom8_ancaman`)),
  `kolom9_risiko_k3ko` text DEFAULT NULL,
  `kolom9_dampak_lingkungan` text DEFAULT NULL,
  `kolom9_celah_keamanan` text DEFAULT NULL,
  `bahaya_manual` text DEFAULT NULL,
  `kolom9_risiko` text NOT NULL,
  `kolom10_pengendalian` text DEFAULT NULL,
  `kolom11_existing` text NOT NULL,
  `kolom12_kemungkinan` int(11) NOT NULL,
  `kolom13_konsekuensi` int(11) NOT NULL,
  `kolom14_score` int(11) NOT NULL,
  `kolom14_level` varchar(255) NOT NULL,
  `kolom15_regulasi` text DEFAULT NULL,
  `kolom16_aspek` varchar(255) DEFAULT NULL,
  `kolom17_risiko` text DEFAULT NULL,
  `kolom17_peluang` text DEFAULT NULL,
  `kolom18_toleransi` varchar(255) NOT NULL DEFAULT 'Ya',
  `kolom19_program_type` varchar(255) DEFAULT NULL,
  `kolom19_pengendalian_lanjut` text DEFAULT NULL,
  `kolom20_kemungkinan_lanjut` int(11) DEFAULT NULL,
  `kolom21_konsekuensi_lanjut` int(11) DEFAULT NULL,
  `kolom22_tingkat_risiko_lanjut` int(11) DEFAULT NULL,
  `kolom22_level_lanjut` varchar(255) DEFAULT NULL,
  `residual_kemungkinan` int(11) NOT NULL,
  `residual_konsekuensi` int(11) NOT NULL,
  `residual_score` int(11) NOT NULL,
  `residual_level` varchar(255) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `pmk_programs` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `document_detail_id` bigint(20) UNSIGNED NOT NULL,
  `judul` varchar(500) NOT NULL,
  `tujuan` text NOT NULL,
  `sasaran` text NOT NULL,
  `penanggung_jawab` varchar(255) NOT NULL,
  `uraian_revisi` text DEFAULT NULL,
  `program_kerja` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`program_kerja`)),
  `status` enum('draft','pending_kepala_unit','pending_kepala_dept','pending_direksi','approved','rejected','revision') DEFAULT 'draft',
  `approved_by_kepala_unit` bigint(20) UNSIGNED DEFAULT NULL,
  `approved_by_kepala_dept` bigint(20) UNSIGNED DEFAULT NULL,
  `approved_by_direksi` bigint(20) UNSIGNED DEFAULT NULL,
...
CREATE TABLE `puk_programs` (
  ...
  `uraian_revisi` text DEFAULT NULL,
  `program_kerja` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`program_kerja`)),
  `status` enum('draft','pending_kepala_unit','approved','rejected','revision') DEFAULT 'draft',
  `approved_by_kepala_unit` bigint(20) UNSIGNED DEFAULT NULL,
...
CREATE TABLE `puk_program_edit_logs` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `puk_program_id` bigint(20) UNSIGNED NOT NULL,
  ...
  `edit_type` varchar(255) NOT NULL DEFAULT 'update',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `role_jabatan` (
  `id_role_jabatan` int(11) NOT NULL,
  `nama_role_jabatan` varchar(50) NOT NULL,
  `deskripsi` text DEFAULT NULL,
...
CREATE TABLE `seksi` (
  ...
  `id_probis` bigint(20) UNSIGNED DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `id_unit` int(11) NOT NULL,
  `id_seksi` int(11) NOT NULL,
  `role_jabatan` int(11) NOT NULL,
  `can_create_documents` tinyint(4) DEFAULT 0,
  `is_reviewer` tinyint(1) DEFAULT 0,
  `is_verifier` tinyint(1) DEFAULT 0,
  `foto_user` int(11) DEFAULT NULL,
  `role_user` int(11) NOT NULL,
  `user_aktif` int(11) NOT NULL DEFAULT 1,
...
--
ALTER TABLE `departemen`
  MODIFY `id_dept` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;
...
--
ALTER TABLE `role_jabatan`
  MODIFY `id_role_jabatan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `seksi`
  MODIFY `id_seksi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=139;

--
-- AUTO_INCREMENT for table `unit`
--
ALTER TABLE `unit`
  MODIFY `id_unit` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;

--
-- AUTO_INCREMENT for table `users`
--
ALTER TABLE `users`
  MODIFY `id_user` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1199;

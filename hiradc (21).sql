...
CREATE TABLE `business_processes` (
  ...
  `nama_probis` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `kode_probis` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `can_create_documents` (
  ...
  `pic` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `departemen` (
  ...
  `nama_dept` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `direktorat` (
  `id_direktorat` int NOT NULL,
  `nama_direktorat` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `deskripsi` text COLLATE utf8mb4_general_ci,
  `status_aktif` tinyint(1) DEFAULT '1',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
...
(4, 'ayokk 2', NULL, 1, '2026-02-08 13:46:49', '2026-02-08 13:47:01');
...
CREATE TABLE `documents` (
  ...
  `kategori` enum('K3','KO','Lingkungan','Keamanan') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'K3',
  `judul_dokumen` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft',
  `revision_number` int NOT NULL DEFAULT '0',
  `revision_reason` text COLLATE utf8mb4_unicode_ci,
  `status_she` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `status_security` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `level2_status` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `compliance_checklist_she` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `compliance_checklist_security` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `current_level` int NOT NULL DEFAULT '0',
  `kolom2_proses` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kolom2_kegiatan` text COLLATE utf8mb4_unicode_ci,
  `kolom3_lokasi` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kolom5_kondisi` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kolom6_bahaya` text COLLATE utf8mb4_unicode_ci,
  `kolom9_risiko` text COLLATE utf8mb4_unicode_ci,
  `kolom10_pengendalian` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `kolom11_existing` text COLLATE utf8mb4_unicode_ci,
  `kolom12_kemungkinan` int DEFAULT NULL,
  `kolom13_konsekuensi` int DEFAULT NULL,
  `kolom14_score` int DEFAULT NULL,
  `kolom14_level` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kolom15_regulasi` text COLLATE utf8mb4_unicode_ci,
  `kolom16_aspek` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kolom17_risiko` text COLLATE utf8mb4_unicode_ci,
  `kolom17_peluang` text COLLATE utf8mb4_unicode_ci,
  `residual_kemungkinan` int DEFAULT NULL,
  `residual_konsekuensi` int DEFAULT NULL,
  `residual_score` int DEFAULT NULL,
  `residual_level` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `published_at` timestamp NULL DEFAULT NULL,
  `last_review_date` date DEFAULT NULL,
  `is_need_evaluation` tinyint(1) NOT NULL DEFAULT '0',
  `is_in_revision` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Flag to track if document is currently in revision workflow',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ;
...
INSERT INTO `documents` (`id`, `id_user`, `assigned_staff_id`, `assigned_by`, `assigned_at`, `id_direktorat`, `id_dept`, `id_unit`, `id_seksi`, `kategori`, `judul_dokumen`, `status`, `revision_number`, `revision_reason`, `status_she`, `she_current_approver_id`, `she_reviewer_id`, `she_verificator_id`, `she_approved_at`, `status_security`, `security_current_approver_id`, `security_reviewer_id`, `security_verificator_id`, `security_approved_at`, `level2_status`, `level2_reviewer_id`, `level2_approver_id`, `level2_assignment_date`, `compliance_checklist`, `compliance_checklist_she`, `compliance_checklist_security`, `current_level`, `kolom2_proses`, `kolom2_kegiatan`, `kolom3_lokasi`, `kolom5_kondisi`, `kolom6_bahaya`, `kolom9_risiko`, `kolom10_pengendalian`, `kolom11_existing`, `kolom12_kemungkinan`, `kolom13_konsekuensi`, `kolom14_score`, `kolom14_level`, `kolom15_regulasi`, `kolom16_aspek`, `kolom17_risiko`, `kolom17_peluang`, `residual_kemungkinan`, `residual_konsekuensi`, `residual_score`, `residual_level`, `published_at`, `last_review_date`, `is_need_evaluation`, `is_in_revision`, `created_at`, `updated_at`) VALUES
(22, 45, NULL, NULL, NULL, 2, 3, 11, 40, 'Keamanan', 'Identifikasi dan Penetapan Mitigasi Risiko Pengamanan', 'pending_level1', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'Production', 'produksi semen', 'sdfghjkl', 'Emergency', '{\"type\":\"\",\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'dfghjk', '{\"hierarchy\":[\"Eliminasi\"],\"new_controls\":[]}', '1. Eliminasi:\r\n   fghjn', 2, 2, 4, NULL, 'fghjk', 'TP', 'fghj', 'fghjk', 1, 1, 0, NULL, NULL, NULL, 0, 0, '2026-02-04 03:37:53', '2026-02-04 03:37:53'),
(26, 45, NULL, NULL, NULL, 2, 3, 11, 40, 'KO', 'Identifikasi dan Penetapan Mitigasi Risiko K3, KO, Aspek Lingkungan', 'published', 0, NULL, 'published', NULL, 146, 585, '2026-02-04 09:00:26', 'none', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '{\"format\":{\"status\":\"OK\",\"note\":\"\"},\"numbering\":{\"status\":\"OK\",\"note\":\"\"},\"revision\":{\"status\":\"OK\",\"note\":\"\"},\"approval\":{\"status\":\"OK\",\"note\":\"\"},\"identification_coverage\":{\"status\":\"OK\",\"note\":\"\"},\"condition_coverage\":{\"status\":\"OK\",\"note\":\"\"},\"mitigation\":{\"status\":\"OK\",\"note\":\"\"}}', NULL, 3, 'Production', 'gaje', 'vghjk', 'Non-Rutin', '{\"type\":\"\",\"kategori\":\"KO\",\"details\":[\"Bahaya Fisika\"],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'ghjk', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 2, 3, 6, NULL, 'uu 12', 'TP', 'ghjkl', 'ghjk', 1, 1, 0, NULL, '2026-02-05 01:38:04', '2026-02-05', 0, 0, '2026-02-04 07:00:42', '2026-02-05 01:38:04'),
(27, 45, NULL, NULL, NULL, 2, 3, 11, 40, 'KO', 'Identifikasi dan Penetapan Mitigasi Risiko K3, KO, Aspek Lingkungan', 'pending_level1', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'Production', 'uiuiu', 'di pabrik', 'Rutin', '{\"type\":\"\",\"kategori\":\"KO\",\"details\":[\"Bahaya Fisika\",\"Bahaya Kimia\"],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'hjk.', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 2, 3, 6, NULL, 'uu 12', 'TP', 'vbhjkl', 'fghjkl', 1, 1, 0, NULL, NULL, NULL, 0, 0, '2026-02-04 07:23:21', '2026-02-04 07:23:21'),
(30, 45, NULL, NULL, NULL, 2, 3, 11, 40, 'Keamanan', 'Identifikasi dan Penetapan Mitigasi Risiko Pengamanan', 'pending_level2', 0, NULL, 'none', NULL, NULL, NULL, NULL, 'pending_head', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 'Production', 'makanan', 'di bumi', 'Emergency', '{\"type\":\"\",\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'gyuio', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 5, 5, 25, NULL, 'uu 12', 'TP', 'ghjuikol', 'tyuio', 1, 1, 0, NULL, NULL, NULL, 0, 0, '2026-02-05 03:15:33', '2026-02-05 03:32:54'),
(31, 45, NULL, NULL, NULL, 2, 3, 11, 40, 'Keamanan', 'Identifikasi dan Penetapan Mitigasi Risiko Pengamanan', 'pending_level1', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'Production', 'dimsum wuenakk', 'pasbar', 'Emergency', '{\"type\":\"\",\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'aman semua', '{\"hierarchy\":[\"Eliminasi\",\"Substitusi\"],\"new_controls\":[]}', '1. Eliminasi:\r\n   eliminasi aja dikit\r\n\r\n2. Substitusi:\r\n   gas ajaa', 2, 2, 4, NULL, 'uu 15', 'TP', 'aman', 'masukk', 1, 1, 0, NULL, NULL, NULL, 0, 0, '2026-02-05 03:30:33', '2026-02-05 03:30:33'),
(32, 45, NULL, NULL, NULL, 2, 3, 11, 40, 'K3', 'Identifikasi dan Penetapan Mitigasi Risiko K3, KO, Aspek Lingkungan', 'pending_level1', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'Production', 'ss', 'ss', 'Non-Rutin', '{\"type\":\"\",\"kategori\":\"K3\",\"details\":[\"Bahaya Fisika\",\"Bahaya Kimia\",\"Bahaya dari Prilaku\"],\"manual\":\"ss\",\"aspects\":[],\"threats\":[]}', 'ss', '{\"hierarchy\":[\"Eliminasi\",\"Substitusi\"],\"new_controls\":[]}', '1. Eliminasi:\r\n   s\r\n\r\n2. Substitusi:\r\n   s', 2, 5, 10, NULL, 'ss', 'TP', 'ss', 'ssss', 1, 1, 0, NULL, NULL, NULL, 0, 0, '2026-02-05 07:57:18', '2026-02-05 07:57:18'),
(33, 45, NULL, NULL, NULL, 2, 3, 11, 40, 'K3', 'Identifikasi dan Penetapan Mitigasi Risiko K3, KO, Aspek Lingkungan', 'pending_level1', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'Production', 'ss', 'ss', 'Emergency', '{\"type\":\"\",\"kategori\":\"K3\",\"details\":[\"Bahaya Fisika\",\"Bahaya Kimia\",\"Bahaya Psikologis\"],\"manual\":\"ss\",\"aspects\":[],\"threats\":[]}', 'ss', '{\"hierarchy\":[\"Eliminasi\",\"Substitusi\"],\"new_controls\":[]}', '1. Eliminasi:\r\n   s\r\n\r\n2. Substitusi:\r\n   s', 4, 2, 8, NULL, 'ss', 'TP', 'ss', 'ss', 1, 1, 0, NULL, NULL, NULL, 0, 0, '2026-02-05 08:31:09', '2026-02-05 08:31:09'),
(34, 45, NULL, NULL, NULL, 2, 3, 11, 40, 'K3', 'Identifikasi dan Penetapan Mitigasi Risiko K3, KO, Aspek Lingkungan', 'pending_level1', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'Production', 'ds', 'dssd', 'Rutin', '{\"type\":\"\",\"kategori\":\"K3\",\"details\":[\"Bahaya Fisika\",\"Bahaya Kimia\"],\"manual\":\"ds\",\"aspects\":[],\"threats\":[]}', 'ss', '{\"hierarchy\":[\"Eliminasi\",\"Substitusi\"],\"new_controls\":[]}', '1. Eliminasi:\r\n   ds\r\n\r\n2. Substitusi:\r\n   ds', 2, 5, 10, NULL, NULL, 'TP', NULL, NULL, 1, 1, 0, NULL, NULL, NULL, 0, 0, '2026-02-05 08:32:50', '2026-02-05 08:32:50'),
(35, 45, NULL, NULL, NULL, 2, 3, 11, 40, 'KO', 'Identifikasi dan Penetapan Mitigasi Risiko K3, KO, Aspek Lingkungan', 'pending_level1', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'Production', 'membaca', 'bangunan', 'Emergency', '{\"type\":\"\",\"kategori\":\"KO\",\"details\":[\"Bahaya Fisika\"],\"manual\":\"ayokla capek\",\"aspects\":[],\"threats\":[]}', 'adad', '{\"hierarchy\":[\"Eliminasi\",\"Substitusi\"],\"new_controls\":[]}', '1. Eliminasi:\r\n   xa\r\n\r\n2. Substitusi:\r\n   zx', 5, 4, 20, NULL, 'xz', 'TP', 'zx', 'zx', 1, 1, 0, NULL, NULL, NULL, 0, 0, '2026-02-05 08:35:49', '2026-02-05 08:35:49'),
(36, 15, NULL, NULL, NULL, 2, 9, 48, 23, 'Keamanan', 'Identifikasi dan Penetapan Mitigasi Risiko Pengamanan', 'pending_level1', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'Production', 'buat bahan bangunan', 'pabrik', 'Emergency', '{\"type\":\"\",\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'pekerja pabrik terpeleset', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 3, 2, 6, NULL, 'uu 12', 'TP', 'produksi lebih efisien', 'pekerja pabrik menjadi aman dan dapat bekerja sepenuh hati', 1, 1, 0, NULL, NULL, NULL, 0, 0, '2026-02-06 01:41:48', '2026-02-06 01:41:48'),
(37, 15, NULL, NULL, NULL, 2, 9, 48, 23, 'Keamanan', 'Identifikasi dan Penetapan Mitigasi Risiko Pengamanan', 'pending_level1', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'Maintenance Productive Asset', 'yuyuy', 'iiiii', 'Emergency', '{\"type\":\"\",\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'wowo', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 5, 2, 10, NULL, 'asaii', 'TP', 'ayokkla', 'walawee', 1, 1, 0, NULL, NULL, NULL, 0, 0, '2026-02-06 01:49:46', '2026-02-06 01:49:46'),
(40, 15, NULL, NULL, NULL, 2, 9, 48, 23, 'Keamanan', 'Identifikasi dan Penetapan Mitigasi Risiko Pengamanan', 'revision', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Maintenance Productive Asset', 'membaca', 'tanah', 'Emergency', '{\"type\":\"\",\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'ghjk', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 3, 5, 15, NULL, 'uu 12', 'TP', 'uiui', 'yuio', 1, 1, 0, NULL, NULL, NULL, 0, 0, '2026-02-06 02:47:28', '2026-02-09 06:44:03'),
(44, 15, NULL, NULL, NULL, 2, 9, 48, 23, 'K3', 'Identifikasi dan Penetapan Mitigasi Risiko K3, KO, Aspek Lingkungan', 'published', 0, NULL, 'published', NULL, 146, 585, '2026-02-08 01:51:50', 'none', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '{\"format\":{\"status\":\"OK\",\"note\":\"\"},\"numbering\":{\"status\":\"OK\",\"note\":\"\"},\"revision\":{\"status\":\"OK\",\"note\":\"\"},\"approval\":{\"status\":\"OK\",\"note\":\"\"},\"identification_coverage\":{\"status\":\"OK\",\"note\":\"\"},\"condition_coverage\":{\"status\":\"OK\",\"note\":\"\"},\"mitigation\":{\"status\":\"OK\",\"note\":\"\"}}', NULL, 4, 'Maintenance Productive Asset', 'pembuatan pipa', 'di pabrik', 'Non-Rutin', '{\"type\":\"\",\"kategori\":\"K3\",\"details\":[\"Bahaya Fisika\",\"Bahaya Kimia\"],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'qwqw', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 5, 5, 25, NULL, '1212', 'TP', 'qwertyuio', 'qwertyuiop', 1, 1, 0, NULL, '2026-02-08 03:09:56', '2026-02-08', 0, 0, '2026-02-08 01:27:50', '2026-02-08 03:09:56'),
(45, 15, NULL, NULL, NULL, 2, 9, 48, 23, 'K3', 'Identifikasi dan Penetapan Mitigasi Risiko K3, KO, Aspek Lingkungan', 'published', 0, NULL, 'published', NULL, 146, 585, '2026-02-08 14:31:04', 'none', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '{\"format\":{\"status\":\"OK\",\"note\":\"\"},\"numbering\":{\"status\":\"OK\",\"note\":\"\"},\"revision\":{\"status\":\"OK\",\"note\":\"\"},\"approval\":{\"status\":\"OK\",\"note\":\"\"},\"identification_coverage\":{\"status\":\"OK\",\"note\":\"\"},\"condition_coverage\":{\"status\":\"OK\",\"note\":\"\"},\"mitigation\":{\"status\":\"OK\",\"note\":\"\"}}', NULL, 4, 'Maintenance Productive Asset', 'upin ipin', 'diklt', 'Non-Rutin', '{\"type\":\"\",\"kategori\":\"K3\",\"details\":[\"Bahaya Fisika\",\"Bahaya Kimia\",\"Bahaya Psikologis\"],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'where', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 3, 2, 6, NULL, 'uu 13', 'TP', 'why', 'what', 1, 1, 0, NULL, '2026-02-08 14:32:38', '2026-02-08', 0, 0, '2026-02-08 14:23:55', '2026-02-08 14:32:38'),
(46, 15, NULL, NULL, NULL, 2, 9, 48, 23, 'Keamanan', 'Identifikasi dan Penetapan Mitigasi Risiko Pengamanan', 'pending_level3_ready', 0, NULL, 'none', NULL, NULL, NULL, NULL, 'approved', NULL, 519, 1018, '2026-02-09 07:04:08', NULL, NULL, NULL, NULL, NULL, NULL, '{\"format\":{\"status\":\"OK\",\"note\":\"\"},\"numbering\":{\"status\":\"OK\",\"note\":\"\"},\"revision\":{\"status\":\"OK\",\"note\":\"\"},\"approval\":{\"status\":\"OK\",\"note\":\"\"},\"identification_coverage\":{\"status\":\"OK\",\"note\":\"\"},\"condition_coverage\":{\"status\":\"OK\",\"note\":\"\"},\"mitigation\":{\"status\":\"OK\",\"note\":\"\"}}', 2, 'Maintenance Productive Asset', 'wertyuiop', 'workshop', 'Emergency', '{\"type\":\"\",\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'rtyuio', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 2, 3, 6, NULL, 'uu 13', 'TP', 'asdfghjkl', 'qwertyuio', 1, 1, 0, NULL, NULL, NULL, 0, 0, '2026-02-08 16:20:38', '2026-02-09 07:04:08'),
(47, 15, NULL, NULL, NULL, 2, 9, 48, 23, 'K3', 'Identifikasi dan Penetapan Mitigasi Risiko K3, KO, Aspek Lingkungan', 'revision', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Maintenance Productive Asset', 'mercon', 'kadai', 'Rutin', '{\"type\":\"\",\"kategori\":\"K3\",\"details\":[\"Bahaya Fisika\",\"Bahaya Kimia\",\"Bahaya dari Prilaku\"],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'harimau', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 3, 5, 15, NULL, 'uu 18', 'TP', 'kucing', 'kasih paham boss', 1, 1, 0, NULL, NULL, NULL, 0, 0, '2026-02-09 06:55:13', '2026-02-09 06:57:30'),
(48, 15, NULL, NULL, NULL, 2, 9, 48, 23, 'Lingkungan', 'Identifikasi dan Penetapan Mitigasi Risiko K3, KO, Aspek Lingkungan', 'revision', 0, NULL, 'revision', NULL, 146, 585, NULL, 'none', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '{\"format\":{\"status\":\"OK\",\"note\":\"\"},\"numbering\":{\"status\":\"OK\",\"note\":\"\"},\"revision\":{\"status\":\"OK\",\"note\":\"\"},\"approval\":{\"status\":\"OK\",\"note\":\"\"},\"identification_coverage\":{\"status\":\"OK\",\"note\":\"\"},\"condition_coverage\":{\"status\":\"OK\",\"note\":\"\"},\"mitigation\":{\"status\":\"OK\",\"note\":\"\"}}', NULL, 2, 'Maintenance Productive Asset', 'lamang tapai', 'usm', 'Normal', '{\"type\":\"\",\"kategori\":\"Lingkungan\",\"details\":[],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'kotor', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 4, 5, 20, NULL, 'uu 13', 'P', 'sdfg', 'qwertyuio', 1, 1, 1, NULL, NULL, NULL, 0, 0, '2026-02-10 04:00:32', '2026-02-10 07:57:29'),
(49, 15, NULL, NULL, NULL, 2, 9, 48, 23, 'Keamanan', 'Identifikasi dan Penetapan Mitigasi Risiko Pengamanan', 'pending_level1', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'Maintenance Productive Asset', 'etek', 'pasar', 'Emergency', '{\"type\":\"\",\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', 'pasasr raya', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 4, 2, 8, NULL, 'uu 23', 'TP', 'jika', 'inovasi', 1, 1, 0, NULL, NULL, NULL, 0, 0, '2026-02-10 07:00:28', '2026-02-10 07:00:28'),
(50, 41, NULL, NULL, NULL, 2, 10, 2, 76, 'K3', 'Identifikasi dan Penetapan Mitigasi Risiko K3, KO, Aspek Lingkungan', 'draft', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '-', 'sfs', 'fdsdf', 'Rutin', '{\"type\":\"\",\"kategori\":null,\"details\":[],\"manual\":\"\",\"aspects\":[],\"threats\":[]}', '-', '{\"hierarchy\":[],\"new_controls\":[]}', '-', 1, 1, 0, NULL, NULL, 'TP', NULL, NULL, 1, 1, 0, NULL, NULL, NULL, 0, 0, '2026-02-12 01:10:33', '2026-02-12 01:10:33');
...
INSERT INTO `document_approvals` (`id`, `document_id`, `level`, `approver_id`, `action`, `catatan`, `changes`, `created_at`, `updated_at`) VALUES
(230, 26, 1, 759, 'approved', 'amann', NULL, '2026-02-04 08:48:52', '2026-02-04 08:48:52'),
(231, 26, 2, 194, 'disposition', 'Disposisi ke Staff (Reviewer Assigned) (Approver Assigned)', NULL, '2026-02-04 08:57:04', '2026-02-04 08:57:04'),
(232, 26, 2, 146, 'reviewed', 'yash', NULL, '2026-02-04 08:58:45', '2026-02-04 08:58:45'),
(233, 26, 2, 585, 'verified', 'mantap boss', NULL, '2026-02-04 08:59:44', '2026-02-04 08:59:44'),
(234, 26, 2, 194, 'approved', 'bagus sangat', NULL, '2026-02-04 09:00:26', '2026-02-04 09:00:26'),
(235, 26, 3, 746, 'approved', 'Dokumen disetujui oleh Kepala Departemen (Track SHE)', NULL, '2026-02-05 01:38:04', '2026-02-05 01:38:04'),
(236, 30, 1, 759, 'approved', 'sudh benar', NULL, '2026-02-05 03:32:54', '2026-02-05 03:32:54'),
(237, 41, 1, 883, 'approved', 'lanjutkan', NULL, '2026-02-06 03:43:49', '2026-02-06 03:43:49'),
(238, 41, 2, 133, 'disposition', 'Disposisi ke Staff (Reviewer Assigned) (Approver Assigned)', NULL, '2026-02-06 04:14:47', '2026-02-06 04:14:47'),
(239, 41, 2, 146, 'reviewed', 'sudah sesuai', NULL, '2026-02-06 04:23:51', '2026-02-06 04:23:51'),
(240, 41, 2, 585, 'verified', 'lanjutt boss', NULL, '2026-02-06 04:24:35', '2026-02-06 04:24:35'),
(241, 41, 2, 133, 'approved', 'sudha sesuai', NULL, '2026-02-06 04:29:42', '2026-02-06 04:29:42'),
(242, 41, 3, 277, 'approved', 'sudah benar (Track SHE) - Forwarded to Direksi', NULL, '2026-02-06 08:00:12', '2026-02-06 08:00:12'),
(243, 41, 3, 277, 'approved', 'sudah bagus - PMK Forwarded to Direksi', NULL, '2026-02-06 08:16:36', '2026-02-06 08:16:36'),
(244, 43, 1, 883, 'approved', 'SUDAH BAGUS', NULL, '2026-02-07 16:47:06', '2026-02-07 16:47:06'),
(245, 43, 2, 133, 'disposition', 'Disposisi ke Staff (Reviewer Assigned) (Approver Assigned)', NULL, '2026-02-07 16:49:19', '2026-02-07 16:49:19'),
(246, 43, 2, 146, 'reviewed', 'sudah sesuai', NULL, '2026-02-07 16:51:28', '2026-02-07 16:51:28'),
(247, 43, 2, 585, 'verified', 'mantap betul lah abg nii', NULL, '2026-02-07 16:52:12', '2026-02-07 16:52:12'),
(248, 43, 2, 133, 'approved', 'dah yok la', NULL, '2026-02-07 16:52:54', '2026-02-07 16:52:54'),
(249, 43, 3, 277, 'approved', 'sudah sesuai pak (Track SHE) - PMK Forwarded to Direksi', NULL, '2026-02-07 16:53:53', '2026-02-07 16:53:53'),
(250, 43, 3, 277, 'approved', 'thnk (Track SHE)', NULL, '2026-02-07 17:11:48', '2026-02-07 17:11:48'),
(251, 43, 3, 277, 'approved', 'sudah benar (Track SHE)', NULL, '2026-02-08 00:34:37', '2026-02-08 00:34:37'),
(252, 44, 1, 883, 'approved', 'kita sepakat', NULL, '2026-02-08 01:28:49', '2026-02-08 01:28:49'),
(253, 44, 2, 133, 'disposition', 'Disposisi ke Staff (Reviewer Assigned) (Approver Assigned)', NULL, '2026-02-08 01:43:52', '2026-02-08 01:43:52'),
(254, 44, 2, 146, 'reviewed', 'sudah sesuai', NULL, '2026-02-08 01:45:31', '2026-02-08 01:45:31'),
(255, 44, 2, 585, 'verified', 'kasih paham boss', NULL, '2026-02-08 01:50:58', '2026-02-08 01:50:58'),
(256, 44, 2, 133, 'approved', 'dokumen sudah sesuai, pegii yukk', NULL, '2026-02-08 01:51:50', '2026-02-08 01:51:50'),
(257, 44, 3, 277, 'approved', 'SUDAH SESUAI (Track SHE) - PMK Forwarded to Direksi', NULL, '2026-02-08 03:09:56', '2026-02-08 03:09:56'),
(258, 44, 4, 1196, 'approved', 'diterima', NULL, '2026-02-08 13:35:26', '2026-02-08 13:35:26'),
(259, 45, 1, 883, 'approved', 'sudah bagus', NULL, '2026-02-08 14:25:59', '2026-02-08 14:25:59'),
(260, 45, 2, 133, 'disposition', 'Disposisi ke Staff (Reviewer Assigned) (Approver Assigned)', NULL, '2026-02-08 14:27:09', '2026-02-08 14:27:09'),
(261, 45, 2, 146, 'reviewed', 'saya serahkan', NULL, '2026-02-08 14:29:29', '2026-02-08 14:29:29'),
(262, 45, 2, 585, 'verified', 'benar', NULL, '2026-02-08 14:30:36', '2026-02-08 14:30:36'),
(263, 45, 2, 133, 'approved', 'kasih paham bos', NULL, '2026-02-08 14:31:04', '2026-02-08 14:31:04'),
(264, 45, 3, 277, 'approved', 'sesuai (Track SHE) - PMK Forwarded to Direksi', NULL, '2026-02-08 14:32:38', '2026-02-08 14:32:38'),
(265, 40, 1, 883, 'revised', 'jelek ya', NULL, '2026-02-09 06:44:03', '2026-02-09 06:44:03'),
(266, 46, 1, 883, 'approved', 'mantapppp', NULL, '2026-02-09 06:55:48', '2026-02-09 06:55:48'),
(267, 47, 1, 883, 'revised', 'mantapp', NULL, '2026-02-09 06:57:30', '2026-02-09 06:57:30'),
(268, 46, 2, 767, 'disposition', 'Disposisi ke Staff (Reviewer Assigned) (Approver Assigned)', NULL, '2026-02-09 07:00:43', '2026-02-09 07:00:43'),
(269, 46, 2, 519, 'reviewed', 'weee', NULL, '2026-02-09 07:02:07', '2026-02-09 07:02:07'),
(270, 46, 2, 1018, 'verified', 'rawrrrrr', NULL, '2026-02-09 07:03:11', '2026-02-09 07:03:11'),
(271, 46, 2, 767, 'approved', 'widdih mantapp boss', NULL, '2026-02-09 07:04:08', '2026-02-09 07:04:08'),
(272, 45, 4, 1196, 'pmk_revision', 'PMK Revision: SUDAH SUDAH', NULL, '2026-02-09 10:08:39', '2026-02-09 10:08:39'),
(273, 45, 0, 15, 'pmk_resubmit', 'PMK telah direvisi dan dikirim ulang', NULL, '2026-02-10 03:33:49', '2026-02-10 03:33:49'),
(274, 48, 1, 883, 'revised', 'form hiradc', NULL, '2026-02-10 04:01:36', '2026-02-10 04:01:36'),
(275, 48, 1, 883, 'revised', 'masih belum benar', NULL, '2026-02-10 07:03:42', '2026-02-10 07:03:42'),
(276, 48, 1, 883, 'revised', 'balik', NULL, '2026-02-10 07:06:15', '2026-02-10 07:06:15'),
(277, 48, 1, 15, 'resubmitted', 'sudah sesuai', NULL, '2026-02-10 07:30:04', '2026-02-10 07:30:04'),
(278, 48, 1, 883, 'revised', 'ulangii masih salah', NULL, '2026-02-10 07:49:13', '2026-02-10 07:49:13'),
(279, 48, 1, 15, 'resubmitted', 'apa yang telah dibuat sudah sesuai', NULL, '2026-02-10 07:51:05', '2026-02-10 07:51:05'),
(280, 48, 1, 883, 'approved', 'sudah', NULL, '2026-02-10 07:52:04', '2026-02-10 07:52:04'),
(281, 48, 2, 133, 'disposition', 'Disposisi ke Staff (Reviewer Assigned) (Approver Assigned)', NULL, '2026-02-10 07:54:32', '2026-02-10 07:54:32'),
(282, 48, 2, 146, 'reviewed', 'sudah sesuai', NULL, '2026-02-10 07:56:19', '2026-02-10 07:56:19'),
(283, 48, 2, 585, 'verified', 'sudah sesuai', NULL, '2026-02-10 07:57:02', '2026-02-10 07:57:02'),
(284, 48, 2, 133, 'revision', 'masih ada kesalahan', NULL, '2026-02-10 07:57:29', '2026-02-10 07:57:29');
...
CREATE TABLE `document_details` (
  ...
  `kolom2_proses` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kolom2_kegiatan` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `kolom3_lokasi` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `kolom4_pihak` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kolom5_kondisi` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `kolom6_bahaya` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `kolom7_aspek_lingkungan` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `kolom8_ancaman` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `kolom9_risiko_k3ko` text COLLATE utf8mb4_unicode_ci,
  `kolom9_dampak_lingkungan` text COLLATE utf8mb4_unicode_ci,
  `kolom9_celah_keamanan` text COLLATE utf8mb4_unicode_ci,
  `bahaya_manual` text COLLATE utf8mb4_unicode_ci,
  `kolom9_risiko` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `kolom10_pengendalian` text COLLATE utf8mb4_unicode_ci,
  `kolom11_existing` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `kolom12_kemungkinan` int NOT NULL,
  `kolom13_konsekuensi` int NOT NULL,
  `kolom14_score` int NOT NULL,
  `kolom14_level` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `kolom15_regulasi` text COLLATE utf8mb4_unicode_ci,
  `kolom16_aspek` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kolom17_risiko` text COLLATE utf8mb4_unicode_ci,
  `kolom17_peluang` text COLLATE utf8mb4_unicode_ci,
  `kolom18_toleransi` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Ya',
  `kolom19_program_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kolom19_pengendalian_lanjut` text COLLATE utf8mb4_unicode_ci,
  ...
  `kolom22_level_lanjut` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `residual_kemungkinan` int NOT NULL,
  `residual_konsekuensi` int NOT NULL,
  `residual_score` int NOT NULL,
  `residual_level` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ;
...
INSERT INTO `document_details` (`id`, `document_id`, `kategori`, `kolom2_proses`, `kolom2_kegiatan`, `kolom3_lokasi`, `kolom4_pihak`, `kolom5_kondisi`, `kolom6_bahaya`, `kolom7_aspek_lingkungan`, `kolom8_ancaman`, `kolom9_risiko_k3ko`, `kolom9_dampak_lingkungan`, `kolom9_celah_keamanan`, `bahaya_manual`, `kolom9_risiko`, `kolom10_pengendalian`, `kolom11_existing`, `kolom12_kemungkinan`, `kolom13_konsekuensi`, `kolom14_score`, `kolom14_level`, `kolom15_regulasi`, `kolom16_aspek`, `kolom17_risiko`, `kolom17_peluang`, `kolom18_toleransi`, `kolom19_program_type`, `kolom19_pengendalian_lanjut`, `kolom20_kemungkinan_lanjut`, `kolom21_konsekuensi_lanjut`, `kolom22_tingkat_risiko_lanjut`, `kolom22_level_lanjut`, `residual_kemungkinan`, `residual_konsekuensi`, `residual_score`, `residual_level`, `created_at`, `updated_at`) VALUES
(30, 22, 'Keamanan', 'Production', 'produksi semen', 'sdfghjkl', NULL, 'Emergency', '{\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', '{\"details\":[\"Terorisme\",\"Sabotase\",\"Perusakan aset\"],\"manual\":\"\"}', NULL, NULL, 'dfghjk', NULL, 'dfghjk', '{\"hierarchy\":[\"Eliminasi\"],\"existing\":\"1. Eliminasi:\\r\\n   fghjn\"}', '1. Eliminasi:\r\n   fghjn', 2, 2, 4, 'Rendah', 'fghjk', 'TP', 'fghj', 'fghjk', 'Ya', NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, 'Rendah', '2026-02-04 03:37:53', '2026-02-04 03:37:53'),
(33, 26, 'KO', 'Production', 'gaje', 'vghjk', NULL, 'Non-Rutin', '{\"kategori\":\"KO\",\"details\":[\"Bahaya Fisika\"],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', 'ghjk', NULL, NULL, NULL, 'ghjk', '{\"hierarchy\":[],\"existing\":null}', '-', 2, 3, 6, 'Sedang', 'uu 12', 'TP', 'ghjkl', 'ghjk', 'Tidak', NULL, 'always', NULL, NULL, NULL, NULL, 1, 1, 1, 'Rendah', '2026-02-04 07:00:42', '2026-02-04 07:00:42'),
(34, 27, 'KO', 'Production', 'uiuiu', 'di pabrik', NULL, 'Rutin', '{\"kategori\":\"KO\",\"details\":[\"Bahaya Fisika\",\"Bahaya Kimia\"],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', 'hjk.', NULL, NULL, NULL, 'hjk.', '{\"hierarchy\":[],\"existing\":null}', '-', 2, 3, 6, 'Sedang', 'uu 12', 'TP', 'vbhjkl', 'fghjkl', 'Tidak', NULL, 'semangatt unutkk', NULL, NULL, NULL, NULL, 1, 1, 1, 'Rendah', '2026-02-04 07:23:21', '2026-02-04 07:23:21'),
(37, 30, 'Keamanan', 'Production', 'makanan', 'di bumi', NULL, 'Emergency', '{\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', '{\"details\":[\"Terorisme\",\"Sabotase\",\"Perusakan aset\"],\"manual\":\"\"}', NULL, NULL, 'gyuio', NULL, 'gyuio', '{\"hierarchy\":[],\"existing\":null}', '-', 5, 5, 25, 'Sangat Tinggi', 'uu 12', 'TP', 'ghjuikol', 'tyuio', 'Tidak', NULL, 'yokk kitaa ulangg', NULL, NULL, NULL, NULL, 1, 1, 1, 'Rendah', '2026-02-05 03:15:33', '2026-02-05 03:15:33'),
(38, 31, 'Keamanan', 'Production', 'dimsum wuenakk', 'pasbar', NULL, 'Emergency', '{\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', '{\"details\":[\"Terorisme\",\"Sabotase\",\"Intimidasi\",\"Pencurian\",\"Perusakan aset\"],\"manual\":\"\"}', NULL, NULL, 'aman semua', NULL, 'aman semua', '{\"hierarchy\":[\"Eliminasi\",\"Substitusi\"],\"existing\":\"1. Eliminasi:\\r\\n   eliminasi aja dikit\\r\\n\\r\\n2. Substitusi:\\r\\n   gas ajaa\"}', '1. Eliminasi:\r\n   eliminasi aja dikit\r\n\r\n2. Substitusi:\r\n   gas ajaa', 2, 2, 4, 'Rendah', 'uu 15', 'TP', 'aman', 'masukk', 'Ya', NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, 'Rendah', '2026-02-05 03:30:33', '2026-02-05 03:30:33'),
(39, 32, 'K3', 'Production', 'ss', 'ss', NULL, 'Non-Rutin', '{\"kategori\":\"K3\",\"details\":[\"Bahaya Fisika\",\"Bahaya Kimia\",\"Bahaya dari Prilaku\"],\"manual\":\"ss\"}', '{\"details\":[],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', 'ss', NULL, NULL, NULL, 'ss', '{\"hierarchy\":[\"Eliminasi\",\"Substitusi\"],\"existing\":\"1. Eliminasi:\\r\\n   s\\r\\n\\r\\n2. Substitusi:\\r\\n   s\"}', '1. Eliminasi:\r\n   s\r\n\r\n2. Substitusi:\r\n   s', 2, 5, 10, 'Tinggi', 'ss', 'TP', 'ss', 'ssss', 'Tidak', NULL, 'ss', 3, 2, 6, 'Sedang', 1, 1, 1, 'Rendah', '2026-02-05 07:57:18', '2026-02-05 07:57:18'),
(40, 33, 'K3', 'Production', 'ss', 'ss', NULL, 'Emergency', '{\"kategori\":\"K3\",\"details\":[\"Bahaya Fisika\",\"Bahaya Kimia\",\"Bahaya Psikologis\"],\"manual\":\"ss\"}', '{\"details\":[],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', 'ss', NULL, NULL, NULL, 'ss', '{\"hierarchy\":[\"Eliminasi\",\"Substitusi\"],\"existing\":\"1. Eliminasi:\\r\\n   s\\r\\n\\r\\n2. Substitusi:\\r\\n   s\"}', '1. Eliminasi:\r\n   s\r\n\r\n2. Substitusi:\r\n   s', 4, 2, 8, 'Sedang', 'ss', 'TP', 'ss', 'ss', 'Ya', NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, 'Rendah', '2026-02-05 08:31:09', '2026-02-05 08:31:09'),
(41, 34, 'K3', 'Production', 'ds', 'dssd', NULL, 'Rutin', '{\"kategori\":\"K3\",\"details\":[\"Bahaya Fisika\",\"Bahaya Kimia\"],\"manual\":\"ds\"}', '{\"details\":[],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', 'ss', NULL, NULL, NULL, 'ss', '{\"hierarchy\":[\"Eliminasi\",\"Substitusi\"],\"existing\":\"1. Eliminasi:\\r\\n   ds\\r\\n\\r\\n2. Substitusi:\\r\\n   ds\"}', '1. Eliminasi:\r\n   ds\r\n\r\n2. Substitusi:\r\n   ds', 2, 5, 10, 'Tinggi', NULL, 'TP', NULL, NULL, 'Tidak', NULL, 'dsd', 3, 1, 3, 'Rendah', 1, 1, 1, 'Rendah', '2026-02-05 08:32:50', '2026-02-05 08:32:50'),
(42, 35, 'KO', 'Production', 'membaca', 'bangunan', NULL, 'Emergency', '{\"kategori\":\"KO\",\"details\":[\"Bahaya Fisika\"],\"manual\":\"ayokla capek\"}', '{\"details\":[],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', 'adad', NULL, NULL, NULL, 'adad', '{\"hierarchy\":[\"Eliminasi\",\"Substitusi\"],\"existing\":\"1. Eliminasi:\\r\\n   xa\\r\\n\\r\\n2. Substitusi:\\r\\n   zx\"}', '1. Eliminasi:\r\n   xa\r\n\r\n2. Substitusi:\r\n   zx', 5, 4, 20, 'Sangat Tinggi', 'xz', 'TP', 'zx', 'zx', 'Tidak', 'PMK', 'zxzx', 4, 2, 8, 'Sedang', 1, 1, 1, 'Rendah', '2026-02-05 08:35:49', '2026-02-05 08:35:49'),
(43, 36, 'Keamanan', 'Production', 'buat bahan bangunan', 'pabrik', NULL, 'Emergency', '{\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', '{\"details\":[\"Terorisme\",\"Sabotase\",\"Intimidasi\",\"Perusakan aset\"],\"manual\":\"\"}', NULL, NULL, 'pekerja pabrik terpeleset', NULL, 'pekerja pabrik terpeleset', '{\"hierarchy\":[],\"existing\":null}', '-', 3, 2, 6, 'Sedang', 'uu 12', 'TP', 'produksi lebih efisien', 'pekerja pabrik menjadi aman dan dapat bekerja sepenuh hati', 'Tidak', 'PUK', 'haalahh halahh', 2, 2, 4, 'Rendah', 1, 1, 1, 'Rendah', '2026-02-06 01:41:48', '2026-02-06 01:41:48'),
(44, 36, 'Keamanan', 'Maintenance Productive Asset', 'ghj', 'ghj', NULL, 'Emergency', '{\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', '{\"details\":[\"Terorisme\",\"Sabotase\"],\"manual\":\"\"}', NULL, NULL, 'ghjklv', NULL, 'ghjklv', '{\"hierarchy\":[\"Eliminasi\",\"Substitusi\"],\"existing\":\"1. Eliminasi:\\r\\n   vghjk\\r\\n\\r\\n2. Substitusi:\\r\\n   vbj\"}', '1. Eliminasi:\r\n   vghjk\r\n\r\n2. Substitusi:\r\n   vbj', 2, 1, 2, 'Rendah', 'uu', 'TP', 'uu', 'ii', 'Ya', NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, 'Rendah', '2026-02-06 01:41:48', '2026-02-06 01:41:48'),
(45, 37, 'Keamanan', 'Maintenance Productive Asset', 'yuyuy', 'iiiii', NULL, 'Emergency', '{\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', '{\"details\":[\"Terorisme\",\"Sabotase\",\"Intimidasi\"],\"manual\":\"\"}', NULL, NULL, 'wowo', NULL, 'wowo', '{\"hierarchy\":[],\"existing\":null}', '-', 5, 2, 10, 'Tinggi', 'asaii', 'TP', 'ayokkla', 'walawee', 'Tidak', 'PMK', 'cepatt siapp yookk yok', 3, 1, 3, 'Rendah', 1, 1, 1, 'Rendah', '2026-02-06 01:49:46', '2026-02-06 01:49:46'),
(46, 37, 'Keamanan', 'Maintenance Productive Asset', 'semen padang', 'ayokla', NULL, 'Emergency', '{\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', '{\"details\":[\"Terorisme\",\"Sabotase\"],\"manual\":\"\"}', NULL, NULL, 'aman kok', NULL, 'aman kok', '{\"hierarchy\":[],\"existing\":null}', '-', 2, 5, 10, 'Tinggi', 'uu 13', 'TP', 'gituu', 'ooooo', 'Tidak', 'PMK', 'yashhh', 1, 2, 2, 'Rendah', 1, 1, 1, 'Rendah', '2026-02-06 01:49:46', '2026-02-06 01:49:46'),
(49, 40, 'Keamanan', 'Maintenance Productive Asset', 'membaca', 'tanah', NULL, 'Emergency', '{\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', '{\"details\":[\"Terorisme\"],\"manual\":\"\"}', NULL, NULL, 'ghjk', NULL, 'ghjk', '{\"hierarchy\":[],\"existing\":null}', '-', 3, 5, 15, 'Tinggi', 'uu 12', 'TP', 'uiui', 'yuio', 'Tidak', 'PMK', 'lahh lahh', 2, 2, 4, 'Rendah', 1, 1, 1, 'Rendah', '2026-02-06 02:47:28', '2026-02-06 02:47:28'),
(55, 44, 'K3', 'Maintenance Productive Asset', 'pembuatan pipa', 'di pabrik', NULL, 'Non-Rutin', '{\"kategori\":\"K3\",\"details\":[\"Bahaya Fisika\",\"Bahaya Kimia\"],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', 'qwqw', NULL, NULL, NULL, 'qwqw', '{\"hierarchy\":[],\"existing\":null}', '-', 5, 5, 25, 'Sangat Tinggi', '1212', 'TP', 'qwertyuio', 'qwertyuiop', 'Tidak', 'PMK', 'pengendalian pipa yang bertebaran', 2, 2, 4, 'Rendah', 1, 1, 1, 'Rendah', '2026-02-08 01:27:50', '2026-02-08 01:27:50'),
(56, 44, 'Lingkungan', 'Maintenance Productive Asset', 'haa aa lah', 'walawe', NULL, 'Normal', '{\"kategori\":\"Lingkungan\",\"details\":[],\"manual\":\"\"}', '{\"details\":[\"Emisi ke udara\",\"Pembuangan ke air\",\"Paparan energi\"],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', NULL, 'were', NULL, NULL, 'were', '{\"hierarchy\":[],\"existing\":null}', '-', 2, 3, 6, 'Sedang', 'pp 12', 'P', 'ertyuio', 'dfghjk', 'Tidak', 'PUK', 'harus ada', 1, 1, 1, 'Rendah', 1, 1, 1, 'Rendah', '2026-02-08 01:27:50', '2026-02-08 01:27:50'),
(57, 45, 'K3', 'Maintenance Productive Asset', 'upin ipin', 'diklt', NULL, 'Non-Rutin', '{\"kategori\":\"K3\",\"details\":[\"Bahaya Fisika\",\"Bahaya Kimia\",\"Bahaya Psikologis\"],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', 'where', NULL, NULL, NULL, 'where', '{\"hierarchy\":[],\"existing\":null}', '-', 3, 2, 6, 'Sedang', 'uu 13', 'TP', 'why', 'what', 'Tidak', 'PUK', 'pengendalian misi boboboii', 2, 2, 4, 'Rendah', 1, 1, 1, 'Rendah', '2026-02-08 14:23:55', '2026-02-08 14:23:55'),
(58, 45, 'Lingkungan', 'Maintenance Productive Asset', 'cabe', 'uiuiu', NULL, 'Normal', '{\"kategori\":\"Lingkungan\",\"details\":[],\"manual\":\"\"}', '{\"details\":[\"Emisi ke udara\",\"Pembuangan ke air\"],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', NULL, 'dfghjkl', NULL, NULL, 'dfghjkl', '{\"hierarchy\":[],\"existing\":null}', '-', 5, 5, 25, 'Sangat Tinggi', 'uu 15', 'P', 'risiko cidera', 'peluang libur', 'Tidak', 'PMK', 'penambahan budget', 3, 1, 3, 'Rendah', 1, 1, 1, 'Rendah', '2026-02-08 14:23:55', '2026-02-08 14:23:55'),
(59, 46, 'Keamanan', 'Maintenance Productive Asset', 'wertyuiop', 'workshop', NULL, 'Emergency', '{\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', '{\"details\":[\"Terorisme\",\"Sabotase\",\"Intimidasi\"],\"manual\":\"\"}', NULL, NULL, 'rtyuio', NULL, 'rtyuio', '{\"hierarchy\":[],\"existing\":null}', '-', 2, 3, 6, 'Sedang', 'uu 13', 'TP', 'asdfghjkl', 'qwertyuio', 'Tidak', 'PUK', 'ada berondong tua', 1, 2, 2, 'Rendah', 1, 1, 1, 'Rendah', '2026-02-08 16:20:38', '2026-02-08 16:20:38'),
(60, 47, 'K3', 'Maintenance Productive Asset', 'mercon', 'kadai', NULL, 'Rutin', '{\"kategori\":\"K3\",\"details\":[\"Bahaya Fisika\",\"Bahaya Kimia\",\"Bahaya dari Prilaku\"],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', 'harimau', NULL, NULL, NULL, 'harimau', '{\"hierarchy\":[],\"existing\":null}', '-', 3, 5, 15, 'Tinggi', 'uu 18', 'TP', 'kucing', 'kasih paham boss', 'Tidak', 'PUK', 'pembuatan baja', 1, 3, 3, 'Rendah', 1, 1, 1, 'Rendah', '2026-02-09 06:55:13', '2026-02-09 06:55:13'),
(61, 48, 'Lingkungan', 'Maintenance Productive Asset', 'lamang tapai', 'usm', NULL, 'Normal', '{\"kategori\":\"Lingkungan\",\"details\":[],\"manual\":\"\"}', '{\"details\":[\"Emisi ke udara\",\"Pembuangan ke air\",\"Pembuangan ke tanah\"],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', NULL, 'kotor', NULL, NULL, 'kotor', '{\"hierarchy\":[],\"existing\":\"-\"}', '-', 4, 5, 20, 'Tinggi', 'uu 13', 'P', 'sdfg', 'qwertyuio', 'Tidak', 'PMK', NULL, 2, 1, 2, 'Rendah', 1, 1, 1, 'Rendah', '2026-02-10 04:00:32', '2026-02-10 07:50:14'),
(62, 49, 'Keamanan', 'Maintenance Productive Asset', 'etek', 'pasar', NULL, 'Emergency', '{\"kategori\":\"Keamanan\",\"details\":[],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', '{\"details\":[\"Terorisme\",\"Sabotase\"],\"manual\":\"\"}', NULL, NULL, 'pasasr raya', NULL, 'pasasr raya', '{\"hierarchy\":[],\"existing\":null}', '-', 4, 2, 8, 'Sedang', 'uu 23', 'TP', 'jika', 'inovasi', 'Tidak', 'PUK', 'swissland', 1, 2, 2, 'Rendah', 1, 1, 1, 'Rendah', '2026-02-10 07:00:28', '2026-02-10 07:00:28'),
(63, 50, 'K3', '-', 'sfs', 'fdsdf', NULL, 'Rutin', '{\"kategori\":null,\"details\":[],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', '{\"details\":[],\"manual\":\"\"}', NULL, NULL, NULL, NULL, '-', '{\"hierarchy\":[],\"existing\":null}', '-', 1, 1, 0, 'Rendah', NULL, 'TP', NULL, NULL, 'Ya', NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, 'Rendah', '2026-02-12 01:10:33', '2026-02-12 01:10:33');
...
CREATE TABLE `foto_user` (
  ...
  `tipe_file` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(21, '2026_02_05_000000_add_residual_risk_columns_collection', 1010),
(22, '2026_02_05_153000_add_program_type_to_document_details', 1011),
(23, '2026_02_09_163111_add_revision_fields_to_pmk_programs_table', 1012),
(24, '2026_02_09_163139_add_revision_fields_to_puk_programs_table', 1013);
...
CREATE TABLE `pmk_programs` (
  ...
  `program_kerja` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `status` enum('draft','pending_kepala_unit','pending_kepala_dept','pending_direksi','approved','rejected','revision') COLLATE utf8mb4_unicode_ci DEFAULT 'draft',
...
--
-- Dumping data for table `pmk_programs`
--

INSERT INTO `pmk_programs` (`id`, `document_detail_id`, `judul`, `tujuan`, `sasaran`, `penanggung_jawab`, `uraian_revisi`, `program_kerja`, `status`, `approved_by_kepala_unit`, `approved_by_kepala_dept`, `approved_by_direksi`, `unit_approval_at`, `dept_approval_at`, `direksi_approval_at`, `rejection_note`, `revision_note`, `revised_by`, `revised_at`, `resubmitted_at`, `created_by`, `created_at`, `updated_at`) VALUES
(8, 37, 'yokk kitaa ulangg', 'uiuiuiui', 'uiuiuiui', 'Unit of Cement Prod', 'moimoii', '[{\"uraian\":\"kita ulang terus ya\",\"koordinator\":\"MUHAMMAD THARIQ, ST., MBA.\",\"target\":[null,\"79\",\"40\",null,null,null,null,null,null,null,null,null],\"anggaran\":80000000}]', 'draft', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 45, '2026-02-05 03:15:33', '2026-02-05 03:32:22'),
(9, 39, 'ss', 'sss', 'ss', 'Unit of Cement Prod', 'ss', '[{\"uraian\":\"ss\",\"koordinator\":\"-\",\"pelaksana\":\"MUHAMMAD THARIQ, ST., MBA.\",\"target\":[null,null,null,null,null,\"22\",\"22\",\"22\",null,null,null,null],\"anggaran\":null}]', 'draft', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 45, '2026-02-05 07:57:18', '2026-02-05 07:57:18'),
(10, 41, 'dsd', 'dsd', 'sdds', 'Unit of Cement Prod', 'dss', '[{\"uraian\":\"dsds\",\"koordinator\":\"-\",\"pelaksana\":\"MUHAMMAD THARIQ, ST., MBA.\",\"target\":[\"22\",null,null,\"22\",\"22\",\"22\",\"12\",null,null,null,null,null],\"anggaran\":\"1231321\"}]', 'draft', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 45, '2026-02-05 08:32:50', '2026-02-05 08:32:50'),
(11, 42, 'zxzx', 'xz', 'xz', 'Unit of Cement Prod', 'zx', '[{\"uraian\":\"xz\",\"koordinator\":\"-\",\"pelaksana\":\"MUHAMMAD THARIQ, ST., MBA.\",\"target\":[\"1\",null,\"2\",null,null,null,null,null,null,null,null,null],\"anggaran\":null}]', 'draft', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 45, '2026-02-05 08:35:49', '2026-02-05 08:35:49'),
(12, 45, 'cepatt siapp yookk yok', 'cepatt', 'uiuiu', 'Unit of Raw Material Prod', 'rtyuio', '[{\"uraian\":\"lah lah lah\",\"koordinator\":\"-\",\"pelaksana\":\"RICKY APRINALDO, ST., Ir.\",\"target\":[null,\"30\",null,null,null,null,null,null,null,null,null,null],\"anggaran\":\"25000000000\"}]', 'draft', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 15, '2026-02-06 01:49:46', '2026-02-06 01:49:46'),
(13, 46, 'yashhh', 'netral', 'amann', 'Unit of Raw Material Prod', 'yuio', '[{\"uraian\":\"pppp\",\"koordinator\":\"-\",\"pelaksana\":\"RICKY APRINALDO, ST., Ir.\",\"target\":[\"90\",null,null,null,null,null,null,null,null,null,null,null],\"anggaran\":\"800000\"}]', 'draft', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 15, '2026-02-06 01:49:46', '2026-02-06 01:49:46'),
(14, 49, 'lahh lahh', 'vbhjk', 'vbnmvbn', 'Unit of Raw Material Prod', 'vbnm', '[{\"uraian\":\"nono\",\"koordinator\":\"-\",\"pelaksana\":\"RICKY APRINALDO, ST., Ir.\",\"target\":[\"80\",\"10\",null,null,null,null,null,null,null,null,null,null],\"anggaran\":null}]', 'draft', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 15, '2026-02-06 02:47:28', '2026-02-06 02:47:28'),
(19, 55, 'pengendalian pipa yang bertebaran', 'uiiu', 'oooo', 'Unit of Raw Material Prod', 'gituu', '[{\"uraian\":\"pengelasan pipa\",\"koordinator\":\"-\",\"pelaksana\":\"RICKY APRINALDO, ST., Ir.\",\"target\":[\"23\",null,null,null,null,null,\"30\",null,null,null,null,null],\"anggaran\":\"00000000\"},{\"uraian\":\"pembuatan dimsum\",\"koordinator\":\"-\",\"pelaksana\":\"RICKY APRINALDO, ST., Ir.\",\"target\":[\"34\",null,null,null,null,null,\"59\",null,null,null,null,null],\"anggaran\":\"2000000\"}]', 'approved', NULL, NULL, 1196, NULL, NULL, '2026-02-08 13:35:26', NULL, NULL, NULL, NULL, NULL, 15, '2026-02-08 01:27:50', '2026-02-08 13:35:26'),
(20, 58, 'penambahan budget', 'wertyuiop', 'wer', 'Unit of Raw Material Prod', 'asdf', '[{\"uraian\":\"mie bangladesh\",\"koordinator\":\"RICKY APRINALDO, ST., Ir.\",\"pelaksana\":\"-\",\"target\":[null,\"30\",null,null,null,null,\"30\",null,null,null,null,null],\"anggaran\":\"15000000\"}]', 'pending_direksi', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1196, '2026-02-09 10:08:39', '2026-02-10 03:33:48', 15, '2026-02-08 14:23:55', '2026-02-10 03:33:48'),
(21, 61, 'Program Pengendalian', 'mantap', 'kebab', 'Unit of Raw Material Prod', 'jenggot', '[{\"uraian\":\"berita acara  10\",\"koordinator\":\"RICKY APRINALDO, ST., Ir.\",\"pelaksana\":\"-\",\"target\":[\"1\",\"20\",null,null,null,null,null,\"40\",null,null,null,null],\"anggaran\":\"80000000\"}]', 'draft', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 15, '2026-02-10 04:00:32', '2026-02-10 09:16:29');
...
CREATE TABLE `puk_programs` (
  ...
  `uraian_revisi` text COLLATE utf8mb4_unicode_ci,
  `program_kerja` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `status` enum('draft','pending_kepala_unit','approved','rejected','revision') COLLATE utf8mb4_unicode_ci DEFAULT 'draft',
  `approved_by_kepala_unit` bigint UNSIGNED DEFAULT NULL,
...
--
-- Dumping data for table `puk_programs`
--

INSERT INTO `puk_programs` (`id`, `document_detail_id`, `judul`, `tujuan`, `sasaran`, `penanggung_jawab`, `uraian_revisi`, `program_kerja`, `status`, `approved_by_kepala_unit`, `approved_at`, `rejection_note`, `revision_note`, `revised_by`, `revised_at`, `resubmitted_at`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 33, 'always', 'vghjkl', 'ghjkl', 'Unit of Cement Prod', NULL, '[{\"uraian\":\"huhuh\",\"koordinator\":\"MUHAMMAD THARIQ, ST., MBA.\",\"pelaksana\":\"ARAHIM\",\"target\":[\"100\",null,null,null,null,null,null,null,null,null,null,null]},{\"uraian\":\"ahhaha\",\"koordinator\":\"MUHAMMAD THARIQ, ST., MBA.\",\"pelaksana\":\"EFFENDI\",\"target\":[null,\"20\",null,null,null,null,null,null,null,null,null,null]}]', 'draft', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 45, '2026-02-04 07:00:42', '2026-02-04 07:00:42'),
(2, 34, 'semangatt unutkk', 'bnm,', 'efbewufbwefueh', 'Unit of Cement Prod', NULL, '[{\"uraian\":\"memakan\",\"koordinator\":\"MUHAMMAD THARIQ, ST., MBA.\",\"pelaksana\":\"ARAHIM\",\"target\":[\"9\",null,null,null,null,null,null,null,null,null,null,null]},{\"uraian\":\"halah\",\"koordinator\":\"MUHAMMAD THARIQ, ST., MBA.\",\"pelaksana\":\"ARAHIM\",\"target\":[null,null,null,null,null,\"4\",null,null,null,null,null,null]}]', 'approved', 759, '2026-02-04 07:40:06', NULL, NULL, NULL, NULL, NULL, 45, '2026-02-04 07:23:21', '2026-02-04 07:40:06'),
(3, 43, 'haalahh halahh', 'mantapp', 'extrajoss', 'Unit of Raw Material Prod', NULL, '[{\"uraian\":\"main\",\"koordinator\":\"RICKY APRINALDO, ST., Ir.\",\"pelaksana\":\"ANDRIA RUKMA\",\"target\":[\"10\",null,null,null,null,null,null,null,null,null,null,null]}]', 'draft', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 15, '2026-02-06 01:41:48', '2026-02-06 01:41:48'),
(6, 56, 'harus ada', 'vbnm,', 'vbnm,', 'Unit of Raw Material Prod', NULL, '[{\"uraian\":\"si gadis\",\"koordinator\":\"RICKY APRINALDO, ST., Ir.\",\"pelaksana\":\"ANDRINALDI\",\"target\":[null,\"89\",null,null,null,null,null,null,\"9\",null,null,null]}]', 'draft', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 15, '2026-02-08 01:27:50', '2026-02-08 01:27:50'),
(7, 57, 'pengendalian misi boboboii', 'cvbnm,', 'rtyuio', 'Unit of Raw Material Prod', NULL, '[{\"uraian\":\"minor\",\"koordinator\":\"RICKY APRINALDO, ST., Ir.\",\"pelaksana\":\"ANDRIA RUKMA\",\"target\":[null,\"90\",null,null,null,null,\"10\",null,null,null,null,null]},{\"uraian\":\"kelapa sawit\",\"koordinator\":\"RICKY APRINALDO, ST., Ir.\",\"pelaksana\":\"ANDRINALDI\",\"target\":[null,null,\"10\",null,null,null,null,null,\"30\",null,null,null]}]', 'draft', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 15, '2026-02-08 14:23:55', '2026-02-08 14:23:55'),
(8, 59, 'ada berondong tua', 'eur', 'riuh', 'Unit of Raw Material Prod', NULL, '[{\"uraian\":\"bani\",\"koordinator\":\"RICKY APRINALDO, ST., Ir.\",\"pelaksana\":\"ANDRIA RUKMA\",\"target\":[\"80\",null,null,null,\"10\",null,null,null,null,null,null,null]}]', 'draft', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 15, '2026-02-08 16:20:38', '2026-02-08 16:20:38'),
(9, 60, 'pembuatan baja', 'sdftgyuiop', 'cvbnm', 'Unit of Raw Material Prod', NULL, '[{\"uraian\":\"uu 12\",\"koordinator\":\"RICKY APRINALDO, ST., Ir.\",\"pelaksana\":\"ANDRINALDI\",\"target\":[null,\"20\",null,null,null,null,\"50\",null,null,null,null,null]}]', 'draft', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 15, '2026-02-09 06:55:13', '2026-02-09 06:55:13'),
(10, 62, 'swissland', 'fghjkl', 'ani cute', 'Unit of Raw Material Prod', NULL, '[{\"uraian\":\"mantap jiwa\",\"koordinator\":\"RICKY APRINALDO, ST., Ir.\",\"pelaksana\":\"ANDRIA RUKMA\",\"target\":[\"90\",null,null,null,null,null,null,null,null,null,null,null]}]', 'draft', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 15, '2026-02-10 07:00:28', '2026-02-10 07:00:28');

-- --------------------------------------------------------

--
-- Table structure for table `puk_program_edit_logs`
--

CREATE TABLE `puk_program_edit_logs` (
  `id` bigint UNSIGNED NOT NULL,
  `puk_program_id` bigint UNSIGNED NOT NULL,
  ...
  `edit_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'update',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ;
...
CREATE TABLE `role_jabatan` (
  ...
  `nama_role_jabatan` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `deskripsi` text COLLATE utf8mb4_general_ci,
...
CREATE TABLE `seksi` (
  ...
  `nama_seksi` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `deskripsi` text COLLATE utf8mb4_general_ci,
  `status_aktif` tinyint(1) DEFAULT '1',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
...
--
-- Table structure for table `tr_document_histories`
--

CREATE TABLE `tr_document_histories` (
  `id` bigint UNSIGNED NOT NULL,
  `document_id` bigint UNSIGNED NOT NULL,
  `revision_number` int NOT NULL DEFAULT '0',
  `revision_reason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `unit` (
  ...
  `kode_unit` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `deskripsi` text COLLATE utf8mb4_general_ci,
  `status_aktif` tinyint(1) DEFAULT '1',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
...
(11, 'ABD.RAHMAN3140', 'ABD RAHMAN', 'ABD.RAHMAN3140@SIG.ID', '$2y$12$uqL.sYY89nEIhtFhgGtzBO/qGYqSzQ5fxemgUeySEldgP7ZoQLVoC', 1, 1, 55, 129, 4, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-09 07:00:36'),
...
(15, 'ABDIANTO', 'ABDIANTO, AMD.', 'ABDIANTO@SIG.ID', '$2y$12$KIB1c6pkMj8HeDTvhyMZcOTC4nQj4z//xBI9dkMbqduxpxPrV3j.G', 2, 9, 48, 23, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
(16, 'ABDUL.HADI3674', 'ABDUL HADI', 'ABDUL.HADI3674@SIG.ID', '$2y$12$guqNI1sN5.Vf7vjyS1otluAo84Z7vF6saX/bZjXDGA0EAyP7hyD/i', 2, 3, 11, 37, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(18, 'ABRIADI', 'ABRIADI', 'ABRIADI@SIG.ID', '$2y$12$/SM/XYiLQXUdY30HRZjZCeKGiD3shHWEHgaVz4oRCmEL1rghn034e', 1, 1, 55, 129, 4, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-09 07:00:36'),
...
(23, 'ADDINU.PUTRA', 'ADDINU EKA PUTRA, SH.', 'ADDINU.PUTRA@SIG.ID', '$2y$12$yLet2Sh.vQUBJeUgsqeDVuH4WgOfawY4bUZnAG0jTQZDEPhDcxgdC', 2, 9, 48, 20, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(45, 'AFIF.AULIA', 'AFIF AULIA', 'AFIF.AULIA@SIG.ID', '$2y$12$ewdQHPfaEKD3iTttToNRbOHtI0Lq84AyAp8knV0/IZoHa8WeKTsHC', 2, 3, 11, 40, 5, 1, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
(46, 'AFINO.FEBRIAN', 'AFINO FEBRIAN', 'AFINO.FEBRIAN@SIG.ID', '$2y$12$URufH9xv7TMkOOBMdgDFDuX9EE.FQa1EHxowFB8bX19TtH0JtAqzy', 2, 9, 48, 20, 6, 1, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(54, 'AFRIYANTO', 'AFRIYANTO', 'AFRIYANTO@SIG.ID', '$2y$12$F1PjmaBdfKwUr2OtJxYL5Os3AHVYl1HXgRUKFiS8l6Jat171I5gl6', 2, 9, 48, 21, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(73, 'AKBAR.RAHMADIAN', 'AKBAR RAHMADIAN', 'AKBAR.RAHMADIAN@SIG.ID', '$2y$12$fiNKmJPjerA9/8BFiFRub.3p5hUQjH9C37GlHDDx3SDqOlfDviGWm', 2, 9, 48, 23, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(100, 'ALIF.YUZA', 'ALIF YUZA, S.TP', 'ALIF.YUZA@SIG.ID', '$2y$12$fxcIj6agVzxvt8XmDC1JT.4O4vqq72CircpVPbWJT8wKJqjK9zq.q', 2, 0, 56, 88, 5, 0, 1, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(104, 'ALMAHDI', 'ALMAHDI', 'ALMAHDI@SIG.ID', '$2y$12$uHUtWDNSAn.g0XGNIww7f.BJFAjGgovVFbjMH1CG1hXsMrqb5xqYW', 2, 9, 48, 22, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(107, 'AMRI.NASUTION', 'AMRI YUSRAN NASUTION', 'AMRI.NASUTION@SIG.ID', '$2y$12$6kS5PF7tHpxlfB/RlOMUbeOWB3dz0gzWNbBOhXxpgl4j3v9Vnjx5a', 1, 1, 55, 129, 4, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-09 07:00:36'),
...
(112, 'AMRULLAH.RANGKUTI', 'AMRULLAH RANGKUTI, ST.', 'AMRULLAH.RANGKUTI@SIG.ID', '$2y$12$EGO8GISa0KleTTcCUZpuyuLSZf8/unRj3mDTCwhY0tJqJDJnCoPBa', 2, 0, 56, 88, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(124, 'ANDRI.ADRINAL7502', 'ANDRI ADRINAL', 'ANDRI.ADRINAL7502@SIG.ID', '$2y$12$oAds8UEPvMCeYiI2Pdkite93XjCnQuJzF3RYGNCT6a1.cqt5uEXQS', 2, 9, 48, 20, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(129, 'ANDRIA.RUKMA', 'ANDRIA RUKMA', 'ANDRIA.RUKMA@SIG.ID', '$2y$12$fd3myinJYX5iCcWvcn.19.LCM9v6601l4uElHVm2Q4TsCwzPqjhwa', 2, 9, 48, 21, 4, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(132, 'ANDRINALDI', 'ANDRINALDI', 'ANDRINALDI@SIG.ID', '$2y$12$Rmw5.D2aJP5lmliJwIqpNuCc.87hC6XeUMGKWCFOeXoWU.yL3PZJW', 2, 9, 48, 20, 4, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
(133, 'ANDY.DANA', 'ANDY RIVA DANA, DR.', 'ANDY.DANA@SIG.ID', '$2y$12$t5QgVILlrWqF//PY2nBSGuSfHCKQ/X6I9XtGraPOjIc/hTxdMV0vG', 2, 0, 56, 72, 3, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(136, 'ANGGA.FULAMDANA', 'ANGGA FULAMDANA', 'ANGGA.FULAMDANA@SIG.ID', '$2y$12$fHEw4KTfq8/qpnfy9akKj.sWAP2n/xZ1vsiKgY2fxOeAHk3I.PLWi', 2, 3, 11, 37, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
(137, 'ANGGA.HANDIKA', 'ANGGA HANDIKA', 'ANGGA.HANDIKA@SIG.ID', '$2y$12$oLTXjeeSOkRbNdyiRghPceoGyxn0wBUz2gFtrFz.eATdBWvrt72YS', 2, 9, 48, 23, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(139, 'ANGGA.RIZANO', 'ANGGA RIZANO, S.S', 'ANGGA.RIZANO@SIG.ID', '$2y$12$uY4ddiGfNdNlRdItdR2R6OAV1cF.uimGbfgc2eIGvCtFlFhwIyiNu', 2, 3, 11, 44, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(146, 'ANTON.WIJAYA', 'ANTON WIJAYA, SE.', 'ANTON.WIJAYA@SIG.ID', '$2y$12$LOlg1c6ufgWcAuZ09UrmUuL3yCmK1kQkTebdVWLfNlYJu5Vq.Wzgi', 2, 0, 56, 109, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(149, 'APRINAL', 'APRINAL', 'APRINAL@SIG.ID', '$2y$12$XRGiqc5FImRTIi5KtWDvMe0Fpa9h7fuAx5Nh9uCeHNENPwoKGpeQm', 2, 3, 11, 44, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(152, 'ARAHIM', 'ARAHIM', 'ARAHIM@SIG.ID', '$2y$12$/69DgXrexQhycUlSt..mQeH91l/4irqtAHxsISaZ8PEj6UEmsOiFG', 2, 3, 11, 37, 4, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(159, 'ARI.UTAMA', 'ARI SATRIA UTAMA', 'ARI.UTAMA@SIG.ID', '$2y$12$p8Eo8BhOrjiiR966QlyWTeuWlheEnPDE6f1rAZEnrgrxeD761Lem6', 2, 9, 48, 22, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(170, 'ARIF.KURNIAWAN3682', 'ARIF KURNIAWAN', 'ARIF.KURNIAWAN3682@SIG.ID', '$2y$12$yfYpMUd2JhH/X2XosY2N2uGYOFTAlsIHRgBDBmEtGWsGYnc6noCjW', 2, 9, 48, 23, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(172, 'ARISMAN.AGUS', 'ARISMAN AGUS', 'ARISMAN.AGUS@SIG.ID', '$2y$12$QUsWo.XvD7z8WOwO8.gI5ObyPu9y5fCpFHXVQF4sN31rdn1jLmVrC', 2, 9, 48, 22, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(179, 'ARMAINI', 'ARMAINI', 'ARMAINI@SIG.ID', '$2y$12$hLvUuZn2ON8iQ9yX1cxQdeptlUMD7qoBxUgQiyZ5nx9ONDul/SuPq', 2, 3, 11, 37, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(193, 'ASRIL.JONI', 'ASRIL JONI, ST.', 'ASRIL.JONI@SIG.ID', '$2y$12$gWrrvBQFHOhpwLbbsRGZfuzHcCUDz5w2pHpH2bMT2evPPMQGw/8u.', 2, 3, 11, 44, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
(194, 'ASRINING.SARI', 'ASRINING SARI, ST.', 'ASRINING.SARI@SIG.ID', '$2y$12$tmNC1ku0jwJASgUyRaTzy.QT/Iruj.qqpOBjALGUrmfAeWIbJELJG', 2, 0, 56, 0, 3, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(207, 'AZMI.DARWIS', 'AZMI DARWIS', 'AZMI.DARWIS@SIG.ID', '$2y$12$RYp3CW/kTQnNr7FoX5Sg6u4O9joETcBLPioJGgbJRYXPRMTy0jxhW', 2, 3, 11, 44, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
(208, 'AZWAR.BAKRI', 'AZWAR BAKRI', 'AZWAR.BAKRI@SIG.ID', '$2y$12$dwjxjbLxpk3pr0BSStOrSe8icCmVmo3gmHNE7dKXxvgjGlYN7C9oi', 2, 9, 48, 20, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
(209, 'BAHAGIA.PERNANDES', 'BAHAGIA PERNANDES', 'BAHAGIA.PERNANDES@SIG.ID', '$2y$12$.IqXzZJR/khn6LpE2mFJquJzeWe8UXQSw.Apl4pwVaat/NkCOMzsC', 2, 0, 56, 88, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(220, 'BENNY.AFRIZAL', 'BENNY AFRIZAL', 'BENNY.AFRIZAL@SIG.ID', '$2y$12$ghKiWCErUp1wcLyC.UdDNOZYucLW.hMfzbO8.K9MGA6M2IhC0ycUi', 2, 9, 48, 23, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(227, 'BERNAST.TANAMAL', 'BERNAST TANAMAL', 'BERNAST.TANAMAL@SIG.ID', '$2y$12$57ZnhxRbXeQvrvoS6PY/X.k.iYlshntc0twCpRY4EPp3ArPM4cDsG', 2, 3, 11, 37, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(229, 'BERRY.SYAMTARIKO', 'BERRY SYAMTARIKO, ST.', 'BERRY.SYAMTARIKO@SIG.ID', '$2y$12$FJfiC0CYvbU2en.iZ6YUSOAZM5vwUxxjEsojwleFKFecVHLJ5y9cy', 2, 3, 11, 44, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(232, 'BETA.JAYA', 'BETA ALEX PUTRA JAYA', 'BETA.JAYA@SIG.ID', '$2y$12$RqppyKz68ygGrBBZ1SLJ9.GuaUwYB14Tb0DNsug8zVGDMUPIicgDi', 2, 3, 11, 44, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(234, 'BINTSAR.TAMPUBOLON', 'BINTSAR PARULLIAN TAMPUBOLON', 'BINTSAR.TAMPUBOLON@SIG.ID', '$2y$12$OCUaNelK8GQgoEP7ou6IXO3yAn3q4vuOVUhpkBP3U8CrMPP99dvl6', 2, 9, 48, 23, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(249, 'CANDRA.FAUZI', 'CANDRA FAUZI', 'CANDRA.FAUZI@SIG.ID', '$2y$12$zV.sLec.zE.SgMhR9oecjuERkR9tT4B45fJ0Wfh1rMLMinOSQY25S', 2, 9, 48, 23, 4, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(251, 'CEGA.MUSLIM', 'CEGA MUSLIM, S.M.', 'CEGA.MUSLIM@SIG.ID', '$2y$12$siM2bf0chlkSZkA1s1OJJOtOzCZdEBdDM0HzjgpcNzUAAi/kUKoFG', 2, 3, 11, 44, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(254, 'DAFIT.ZULKIFLI', 'DAFIT ZULKIFLI', 'DAFIT.ZULKIFLI@SIG.ID', '$2y$12$XZ8KbJ6BmdGe/a4oiZYMV.Xoxkxlu/ealg71DpzH3bZfyOM/icFXu', 2, 9, 48, 20, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(259, 'DANNY.SATRIA', 'DANNY SATRIA', 'DANNY.SATRIA@SIG.ID', '$2y$12$zjUmo5ZRfRlSnepeLxouNu6xUerer7qNmHtQspNVozUPZ/6qxAh9y', 2, 3, 11, 44, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(276, 'DEDI.SILABAN', 'DEDI MEIER SILABAN', 'DEDI.SILABAN@SIG.ID', '$2y$12$Nx8te2XIEg/xEnYFvFk3wexpEWPQ4Ga24j9YOeNeRfZhut2kSjk9u', 2, 3, 11, 40, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(281, 'DEFRIZAL.ZED', 'DEFRIZAL ZED', 'DEFRIZAL.ZED@SIG.ID', '$2y$12$bqi.G7VPyGsf6iQ2KvO3Ue8i8q9xLIM6zovlycwvDL7ed0CpB9P1W', 2, 9, 48, 22, 4, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(291, 'DERI.PUTRA', 'DERI YUNI PUTRA', 'DERI.PUTRA@SIG.ID', '$2y$12$QWXgC/WzbTukzlvN27XQO.IBj8hSSR1X.s7Rt1wLfwtWGOyRU12KO', 2, 9, 48, 21, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(294, 'DESFIRMAN', 'DESFIRMAN', 'DESFIRMAN@SIG.ID', '$2y$12$BK5OtoTprLeXAj4X2NDc4ugQDct2BJXJpY2h9mN2H0NA2UT5lT7cm', 2, 9, 48, 21, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(309, 'DIAN.HANDRIKO', 'DIAN HANDRIKO', 'DIAN.HANDRIKO@SIG.ID', '$2y$12$sb50B3P5f1PhQua6T80z5.9RLzdLR94ESFA1YtgtArsE4es9asYfe', 2, 9, 48, 21, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(313, 'DIDA.EFFENDI', 'DIDA EFFENDI', 'DIDA.EFFENDI@SIG.ID', '$2y$12$rtJ6xxT/OaSnS/DBKpYhC.jcTouEElvNxUWu56/zadFaWZamJuFUO', 2, 3, 11, 40, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(315, 'DIDI.KURNIAWAN', 'DIDI KURNIAWAN', 'DIDI.KURNIAWAN@SIG.ID', '$2y$12$enYEUd6ncjuMBtWh99VEYOyBjpWaOvjXKkQpKYtfJVlHtFE3QL/iS', 2, 9, 48, 23, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(325, 'DODI.SUPRIADI', 'DODI SUPRIADI', 'DODI.SUPRIADI@SIG.ID', '$2y$12$zfXBsxXTMdeYjvcoiFi3XuR2rnhAtRoZPDpHxjCcs3RNUOSbGNe4S', 1, 1, 55, 129, 4, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-09 07:00:36'),
...
(358, 'EDY.SURYANTO', 'EDY SURYANTO', 'EDY.SURYANTO@SIG.ID', '$2y$12$34GrtzZ0FBP0XqB2cDC0EuOoiEwV.hErt5WghgNFlMO2f3sfiFlHO', 2, 9, 48, 22, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
(359, 'EFFENDI', 'EFFENDI', 'EFFENDI@SIG.ID', '$2y$12$w3GD7qb9liQfm2JThGerA.UHj.3UEzN9eZw84JRdmcH8sXrKztqnG', 2, 3, 11, 44, 4, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(384, 'ERICK.RINALDO', 'ERICK RINALDO', 'ERICK.RINALDO@SIG.ID', '$2y$12$0FvfleEGyCQFQDmQBtPQDupd2hi.2k0e6udVs0A7DA13tfnQ.7vMe', 2, 9, 48, 20, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(406, 'FAKHRIZAL', 'FAKHRIZAL', 'FAKHRIZAL@SIG.ID', '$2y$12$r5GAWtvqPblM5euLIwk01.BmW6ps.Kmjl5dy6fLxkgF610Nj8KQk2', 2, 3, 11, 40, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(412, 'FARDIANTO', 'FARDIANTO', 'FARDIANTO@SIG.ID', '$2y$12$cEcfnDBPoL.1I5ZaL6AhOOhbwI4uS7pezItbI3t1SBYqnpdpliSSC', 2, 3, 11, 40, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(435, 'FERDY.DINARDO', 'FERDY DINARDO, ST.', 'FERDY.DINARDO@SIG.ID', '$2y$12$uj/7aqJot8J8imzgRgrIC.lUGtOg.IOSGMBDxOplHjvuBNlTHY0Pa', 2, 0, 56, 88, 4, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(443, 'FERNANDA.PUTRA', 'FERNANDA EKA PUTRA, S.Kom.', 'FERNANDA.PUTRA@SIG.ID', '$2y$12$YGPgdJxeeQltHNg7gnT4ceXinCnk1xyvCoA32QEzgI1erqMIOufLq', 2, 0, 56, 109, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
(444, 'FERNANDO.COSTA', 'FERNANDO DA COSTA', 'FERNANDO.COSTA@SIG.ID', '$2y$12$LsrSGSlJfjSgPeHfJfAab.y9Z5dPUrqeKp3.aZVffJNInCWtQefIK', 2, 3, 11, 44, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(454, 'FIONA.INDRIANI', 'FIONA INDRIANI', 'FIONA.INDRIANI@SIG.ID', '$2y$12$JPF9S5C7Kvtyo4ggvOOaqe5rWkUhpfBHQc8eh8uYd2RYk3vFbYmnK', 2, 0, 56, 72, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(469, 'FREZI.YULILHAMRI', 'FREZI YULILHAMRI', 'FREZI.YULILHAMRI@SIG.ID', '$2y$12$rQkARcO2fx66d3E6JYwad.Mz4ooFScFZ/f/m2DL5SR8AFbgJ34.eK', 2, 3, 11, 44, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(487, 'HALVIKA.PADMA', 'HALVIKA PADMA', 'HALVIKA.PADMA@SIG.ID', '$2y$12$gWzc8zWJr9C4IsLjN4oP3uo4Dw.Ol9rmCopzNVKmyemz9d5QpnEw2', 2, 3, 11, 37, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(497, 'HARIYANDA.A', 'HARIYANDA ADILESTAMAN', 'HARIYANDA.A@SIG.ID', '$2y$12$SDb00wGVtGSdlHSRy9WyKuJ3/g..CNw7gdBRGGS3bn3V1opOpIzQS', 2, 3, 11, 37, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(499, 'HARMONI', 'HARMONI', 'HARMONI@SIG.ID', '$2y$12$Ayjiaea1yKPk5SayBqJMcOuJ3Wy6QUjjJBwh3aEwiNyUEiVppDMwe', 2, 9, 48, 21, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(509, 'HELMIZAR', 'HELMIZAR', 'HELMIZAR@SIG.ID', '$2y$12$qOJY/7Eh2iFH2z.ENHYgzOooC11wAAHWqTzDHm6yj/YM114c43D0G', 2, 3, 11, 37, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(518, 'HENDRA.YUDI', 'HENDRA YUDI, ST.', 'HENDRA.YUDI@SIG.ID', '$2y$12$RZR1DACxByYPu8DVerpWJeiJ7t4Oe68upn0lcu3TY/l1yX6GAzXFq', 2, 3, 11, 40, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
(519, 'HENDRATMO', 'HENDRATMO, SH', 'HENDRATMO@SIG.ID', '$2y$12$GzTrEb5ALPFk7OZvfUYSdu3uj8Oc9mrrxfywVuqwdpz9yg9z3fK0e', 1, 1, 55, 129, 6, 0, 1, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-09 07:00:36'),
...
(525, 'HENDRI.SATRIA', 'HENDRI SATRIA', 'HENDRI.SATRIA@SIG.ID', '$2y$12$tA3YwWijAmkefAXpMnYxpenA/ZGelL94dckuN6eCuvWeM8eDrcMca', 2, 3, 11, 40, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(581, 'ILVI.WALDEVRI', 'ILVI WALDEVRI', 'ILVI.WALDEVRI@SIG.ID', '$2y$12$S/jySrBrqOp1RuCVyhml1ODps9Lx8AmZZkQGv1Tp.DIyYtS9/VPHK', 2, 0, 56, 109, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(585, 'IMRISAL', 'IMRISAL', 'IMRISAL@SIG.ID', '$2y$12$bq3dfaREBSeQrjFhvSlCEuNauIjy5JU222im0ouYsxWvCRrrLSe6O', 2, 0, 56, 109, 4, 0, 0, 1, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(593, 'INDRIA.HAPSARI', 'INDRIA HAPSARI, ST.', 'INDRIA.HAPSARI@SIG.ID', '$2y$12$veVNphHZDI5SR4EHoIY9xelp59aEfADIZCmX.xUrRBHz.89eDfoR2', 2, 0, 56, 88, 4, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(623, 'JANUMARINOS', 'JANUMARINOS, SE.', 'JANUMARINOS@SIG.ID', '$2y$12$svcIQONlqQuMFs3zuvdbheqO5mFa0PdhEagp.woobXZVcnU1Duhhy', 2, 3, 11, 40, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
(624, 'JANWARMAN', 'JANWARMAN', 'JANWARMAN@SIG.ID', '$2y$12$lR1oDlv0/sIcy8h8QItWyuacC.8IwGOwm5s7eva4zHOUuFxVtCr66', 2, 3, 11, 40, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(626, 'JEFRI.ANTONI3386', 'JEFRI ANTONI', 'JEFRI.ANTONI3386@SIG.ID', '$2y$12$OI8JGKZe5jzFK/DiefYBC.aDfTnbFIgdR9GKASyFMXAF4EM0DkCFK', 2, 0, 56, 109, 4, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(631, 'JESRIWAL', 'JESRIWAL, SE.', 'JESRIWAL@SIG.ID', '$2y$12$GZGvxVNbtYBbj1kIowsuN.nn3o.b84UImPoBwXvpd4D4l76H98gEq', 2, 0, 56, 109, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(636, 'JHONNY.MANIK', 'JHONNY WAN OF MANIK', 'JHONNY.MANIK@SIG.ID', '$2y$12$P6SET5Sw3idBOeX03QI3D.mH8xMW/RSPZHITToBULJfafI47Bubtu', 2, 9, 48, 23, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
(637, 'JHOVI.HAVIL', 'JHOVI HAVIL', 'JHOVI.HAVIL@SIG.ID', '$2y$12$8ef.vPKkGFc6jA5mIZyygesP/03JWJkMf3LBD/9XivVNqv0dmr6QK', 2, 3, 11, 37, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(663, 'JUNAIDI.N', 'JUNAIDI N', 'JUNAIDI.N@SIG.ID', '$2y$12$n/Cg7ATNnw.qLNSknwRMhufqTpmhQEYmdpS0RZZXjjx8KXWxbq07e', 2, 3, 11, 40, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(681, 'LIDYA.LIZA', 'LIDYA ROSA LIZA', 'LIDYA.LIZA@SIG.ID', '$2y$12$3bcCQVWnZkRCxA1ohAGBw.ypARdO3ZReR45RBsNXtjjwJRXEx.fOC', 2, 0, 56, 109, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(686, 'ADI.PUTRA', 'M ADI PUTRA', 'ADI.PUTRA@SIG.ID', '$2y$12$SqvM8Zxi6Z/RM2nEgd0vTe/9u6qcrmaHO5i5ys8XnoOa5z6MSKpbi', 2, 9, 48, 22, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(688, 'ANDEKA.FRANDALA', 'M ANDEKA FRANDALA, ST.', 'ANDEKA.FRANDALA@SIG.ID', '$2y$12$akCtC5zD70CcGJI4KkM9BOCBpjcgwM3LpYPqhizquWxAgxqo0p0f6', 2, 0, 56, 88, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(697, 'MAISON.ISKANDAR', 'MAISON ISKANDAR', 'MAISON.ISKANDAR@SIG.ID', '$2y$12$68Q21FSABmqaGGj4U3VHpurzIMJ5p44ZqmqbUzVcorx.j4ZgTwGrK', 2, 3, 11, 44, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(704, 'MARLIUSMAN', 'MARLIUSMAN', 'MARLIUSMAN@SIG.ID', '$2y$12$gIlin27VuZGl51rMvOl5CO3crC/dFYZGb30cf/dc90rj6EVGkdv9y', 2, 9, 48, 23, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(708, 'MARTOYO', 'MARTOYO', 'MARTOYO@SIG.ID', '$2y$12$1EbjozRtJzYugJriZq39HeKolj.Fuz/BXN0CK2Jd8rrJ42whT.x/e', 2, 9, 48, 21, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07');
INSERT INTO `users` (`id_user`, `username`, `nama_user`, `email_user`, `password`, `id_direktorat`, `id_dept`, `id_unit`, `id_seksi`, `role_jabatan`, `can_create_documents`, `is_reviewer`, `is_verifier`, `foto_user`, `role_user`, `user_aktif`, `last_login`, `created_at`, `updated_at`) VALUES
...
(725, 'MHD.YAKIN', 'MHD  YAKIN, ST.', 'MHD.YAKIN@SIG.ID', '$2y$12$RAdKsn3.kWKeUZEdUGqAjeR3h25i1x7FKL9e0q1ovYAw3aXXUUWDa', 2, 9, 48, 22, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(759, 'MUHAMMAD.THARIQ', 'MUHAMMAD THARIQ, ST., MBA.', 'MUHAMMAD.THARIQ@SIG.ID', '$2y$12$Z2ux0yUKQ2fuXaDcHLxI1uELfVuXXPmqTUOod9thE1tjgvpzfb3O.', 2, 3, 11, 0, 3, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(765, 'MUKHLIS', 'MUKHLIS', 'MUKHLIS@SIG.ID', '$2y$12$wNaQxBaAoj8avy4otfYgkOTOywBbFVBVah9y6AS4ayYYcptitXIXu', 2, 3, 11, 44, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
(766, 'MUKHRIAL', 'MUKHRIAL', 'MUKHRIAL@SIG.ID', '$2y$12$KBc7EeeIfLKZFtSCCoXBaeJ8DB2BUQBtzgKbeLm/0I9NSzUxtvjyG', 2, 9, 48, 21, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
(767, 'MULYA.PUTRA', 'MULYA ANDHIKA PUTRA, ST., M.Env.Eng.', 'MULYA.PUTRA@SIG.ID', '$2y$12$/MBNqcxG4ynVdlv/xRXeuOHQ8OlBchtLlukLKNyiKXLvln7ueWCZW', 1, 1, 55, 129, 3, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-09 07:00:36'),
...
(783, 'NAZIRMAN', 'NAZIRMAN', 'NAZIRMAN@SIG.ID', '$2y$12$paDivkI8R46ABm6.I0tVROzp6yf0w0hlLSfQPkqbYyaPY/y8Tjy2m', 2, 9, 48, 20, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(785, 'NENENG.OKTAFIA', 'NENENG OKTAFIA, SE.', 'NENENG.OKTAFIA@SIG.ID', '$2y$12$/1R2ep3ScTAR4VSpek0iEeQIhEQsGYfELBtTphcmbh2Wsvfc1Q5w.', 2, 0, 56, 72, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(803, 'NOVIAN.SISKA', 'NOVIAN SISKA', 'NOVIAN.SISKA@SIG.ID', '$2y$12$c.pxxkRTQRDoICVm8LI5..G/O7hUDFE/qs.ks828eXUoWI3nhr4Vy', 2, 3, 11, 40, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(859, 'RATHOMI.ANDIKA', 'RATHOMI ANDIKA', 'RATHOMI.ANDIKA@SIG.ID', '$2y$12$mHu4uJeutd9337VSIKbnkenUlkBMcX0N5zInS7p363zjPOyW3gMBG', 2, 3, 11, 37, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(866, 'REFKI', 'REFKI, ST', 'REFKI@SIG.ID', '$2y$12$Lo0QUnGBVTEnXSNtekRhAObAYqTUzJ4pblGt1ywemIRvUnw6MrY6y', 2, 9, 48, 21, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(872, 'RENO.ZAPUTRA', 'RENO ZAPUTRA', 'RENO.ZAPUTRA@SIG.ID', '$2y$12$dRM4D7IJ3Sa3Qg36irg0UeQZmMHcKw.2XJEo96BG2SfB7x1u31/Fy', 2, 3, 11, 44, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(878, 'REZHA.ARNALDY', 'REZHA ARNALDY', 'REZHA.ARNALDY@SIG.ID', '$2y$12$LrJkhmNabBohPVVgEd81AuTY44oez2h1Ql2bAqSG.5bkhQa3/6kn2', 2, 9, 48, 20, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
(879, 'REZY.ADAM', 'REZY MELANO ADAM', 'REZY.ADAM@SIG.ID', '$2y$12$FQspCqQFqPpon68iEocLseQe3imVNYL9psdEkwX/Cuo.92iI5/SAu', 2, 3, 11, 40, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(883, 'RICKY.APRINALDO', 'RICKY APRINALDO, ST., Ir.', 'RICKY.APRINALDO@SIG.ID', '$2y$12$T6h33yUo27uLPVd0n4NgduvuV/CsEwOMltELJ1kd/lEqD821GpLES', 2, 9, 48, 0, 3, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
(884, 'RICKY.SYAHPUTRA', 'RICKY EDI SYAHPUTRA', 'RICKY.SYAHPUTRA@SIG.ID', '$2y$12$PdRdeIIJBOjduSzN.KXhY.IK5zBJcnpDiHfk2hUZfaAMPDaQwPeNG', 2, 9, 48, 20, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
(885, 'RICKY.KURNIAWAN', 'RICKY KURNIAWAN, ST.', 'RICKY.KURNIAWAN@SIG.ID', '$2y$12$tg4w96bJ/zVhs80hBTxMPOWHmoTu.6bHSND8Jw.eSDQtxobMyn02W', 2, 0, 56, 109, 4, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(901, 'RIHAN.FERNANDO', 'RIHAN FERNANDO', 'RIHAN.FERNANDO@SIG.ID', '$2y$12$.CHHs1OyKmRz5xXXaj9WnORG7VAK/RU9dA./F7gwTSQ1rawLfHzgK', 2, 9, 48, 20, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(904, 'RIKA.RACHMAN', 'RIKA RACHMAN, SE.', 'RIKA.RACHMAN@SIG.ID', '$2y$12$YGIQ4cw21MYAcmAA9urWn.gqgMDQhsoYU3v9yFoo0GpNlcrZXufgK', 2, 0, 56, 88, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(917, 'RINI.UTARI', 'RINI UTARI', 'RINI.UTARI@SIG.ID', '$2y$12$2USwsoLYtj3iQvUUtQ2oNuo30IHT6h00TSooZv5Ip43Jyvpq3HZ/C', 2, 0, 56, 109, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(929, 'RIZKI.APRINANDA', 'RIZKI APRINANDA, S. Kom', 'RIZKI.APRINANDA@SIG.ID', '$2y$12$VN4lMULn4LMzbEsNCO6qHeK8vdJqe6ii5pmID.Yfofd5/9c9dIhDe', 2, 3, 11, 44, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(935, 'ROBBY.HANDAYA', 'ROBBY HANDAYA', 'ROBBY.HANDAYA@SIG.ID', '$2y$12$R832PUaH7VS36MV7tLcpuOpHxnpTbMHjwCa5BpETp43x9YAQt0JZm', 2, 0, 56, 109, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(943, 'ROCKY.JUNAIDI', 'ROCKY EDOS JUNAIDI', 'ROCKY.JUNAIDI@SIG.ID', '$2y$12$jzHrR486139YNamsQAnEUuIrhLnZRDPYDeeB7emCJpfD58oOb7HHy', 2, 3, 11, 40, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(946, 'ROMI.ANDRIA', 'ROMI ANDRIA, SE.', 'ROMI.ANDRIA@SIG.ID', '$2y$12$4/HvdhiOD.h4dvWWA585ZOZ0vdE7pchjwqgZRO5QXK5FkrbX4TZL.', 2, 3, 11, 37, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(953, 'RONI.CHANDRA', 'RONI CHANDRA', 'RONI.CHANDRA@SIG.ID', '$2y$12$tvxjYLuf.Fh9sHy5fnPCoOKpkjrJBrp8QEQnz3ZP3IdYjM4kDcG1i', 2, 0, 56, 109, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(966, 'RUDI.NOFIANDRI', 'RUDI NOVIANDRI', 'RUDI.NOFIANDRI@SIG.ID', '$2y$12$FrZk5vgECtiQLCVVqnGZ0OM5590YH.z3T0IGgV7yQBhD.jfqdry4m', 2, 3, 11, 40, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(974, 'RUSTAM.3079', 'RUSTAM', 'RUSTAM.3079@SIG.ID', '$2y$12$RofnClhmH4k7DFE0wm4HQuUnR.V8cA68br.2oewwIKx25OhwmV06i', 2, 3, 11, 40, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(995, 'SATRIA.BUANA', 'SATRIA BUANA', 'SATRIA.BUANA@SIG.ID', '$2y$12$ZBA0671L0zjhzaRb1jROZ.YznWxx9jmFPvbOLF0ZigbBkgbVzpoLu', 2, 0, 56, 109, 5, 1, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(998, 'SAWONO', 'SAWONO', 'SAWONO@SIG.ID', '$2y$12$13mfz8PGTD1QHnLw8KdvNO.1jHflcz9szb4xXAYwLRhwby5HS0nri', 2, 9, 48, 21, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(1018, 'SUBRIANTO', 'SUBRIANTO, SH.', 'SUBRIANTO@SIG.ID', '$2y$12$rBNesyFuk5up04OPvy9upes984IaJdW5rXTKCNPEL59SClczaTRTS', 1, 1, 55, 129, 4, 0, 0, 1, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-09 07:00:36'),
...
(1033, 'SUSILAWATY', 'SUSILAWATY', 'SUSILAWATY@SIG.ID', '$2y$12$7DAlkPe3Bn2dEoKLdQ1E7.7XJEG8Ux5F6fg3etAiax3LH1.dVWkWK', 2, 0, 56, 72, 4, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(1042, 'SYAFRIL.A', 'SYAFRIL A', 'SYAFRIL.A@SIG.ID', '$2y$12$tmVgFr4PqXJyMDWMEzuqNO8v/DwU9K77Js1IUr9tUYyKSiXGgSjla', 2, 9, 48, 23, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(1044, 'SYAFRIYAL', 'SYAFRIYAL', 'SYAFRIYAL@SIG.ID', '$2y$12$Ome0x6dBBKkoddGxoE/nDO.u9E03OYjSCy.MFhfRvk/8AUnaD7yxO', 2, 3, 11, 40, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(1061, 'TELLI.ANGGELINA', 'TELLI MERIZA ANGGELINA', 'TELLI.ANGGELINA@SIG.ID', '$2y$12$xlEXm2YfKQviH3ha/ggC1OnMOmMiM.k.b/q1m6xZuAw74Wu2aPR3W', 2, 0, 56, 72, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(1071, 'TRI.SUDARNO', 'TRI SUDARNO', 'TRI.SUDARNO@SIG.ID', '$2y$12$KpMoJOrnsjOYt37KM5JDmeQfAS42UOKHJOWzWyzt8XBgAtj1sftxO', 2, 0, 56, 109, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(1087, 'VIRA', 'VIRA, SE.', 'VIRA@SIG.ID', '$2y$12$aYXnuVUSxGhijMaak9IFkeNlEYehqG5iJdFOIvBx./KKLYEI1KtIe', 2, 0, 56, 109, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-12 02:22:58'),
...
(1097, 'WAHYUDI.8278', 'WAHYUDI, SH.', 'WAHYUDI.8278@SIG.ID', '$2y$12$bcuhImVE9NkErO6zvmwvWu3VGXKsV5jbp1ynDYQ25NQxh43IXe/im', 1, 1, 55, 0, 3, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-09 07:00:36'),
...
(1101, 'WARDI.3164', 'WARDI', 'WARDI.3164@SIG.ID', '$2y$12$WA7T08cs3GpXo/yaR66RieRWdm9TsSm93Qj3BxZd4.BkFM7dfH9O.', 2, 9, 48, 21, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(1107, 'WERY.FRIMA', 'WERY FRIMA', 'WERY.FRIMA@SIG.ID', '$2y$12$yv6pezjTkPOaXzVkoYL0LOgoPBv5kAkNgnrDQHnDmvto6PLNDIA4i', 2, 3, 11, 2, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(1109, 'WILLIE.ANTHONI', 'WILLIE ANTHONI, ST.', 'WILLIE.ANTHONI@SIG.ID', '$2y$12$ltCqjkPW3zEV/2ZlFjMn3.BHHvwBeThcWWeXUr/h37DdU7/zfGKJm', 1, 1, 55, 129, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-09 07:00:36'),
...
(1162, 'YULIANDRI', 'YULIANDRI', 'YULIANDRI@SIG.ID', '$2y$12$ZDPycCntywa.TzISQGETYOWrCC59o6U5xOjkPYYB24Bb5no9cx02u', 2, 9, 48, 21, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
...
(1174, 'ZEINIAL', 'ZEINIAL', 'ZEINIAL@SIG.ID', '$2y$12$9ZhY.eWnR8Fr6JfcBkHjnOMXdq69i4tUVlz7FHPf3egS9FKntkWEO', 2, 3, 11, 40, 5, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(1178, 'ZUL.ARMEN', 'ZUL ARMEN', 'ZUL.ARMEN@SIG.ID', '$2y$12$4DOhefHaOdPeLlOvjZ0Ltep/OHmmkCkxVuwmfq1RPF0zhzFbaioCG', 2, 3, 11, 44, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
(1181, 'ZULFADHLY.SAPUTRA', 'ZULFADHLY SAPUTRA', 'ZULFADHLY.SAPUTRA@SIG.ID', '$2y$12$EgjbwwPlIRF8qkauzRp1dOt09EqIU/sr4VqtfPRtsyOvtUu/YazJu', 2, 9, 48, 23, 6, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-11 08:20:07'),
(1182, 'ZULFAHMI.3268', 'ZULFAHMI', 'ZULFAHMI.3268@SIG.ID', '$2y$12$fTyW420X30cjMLtqeoRSMu3yRM.Orz4TA88MuXvSDtapWncb7g4o2', 2, 3, 11, 40, 4, 0, 0, 0, NULL, 2, 1, NULL, '2026-01-20 06:15:10', '2026-02-04 02:37:32'),
...
CREATE TABLE `user_aktif_status` (
  ...
  `nama_status` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `deskripsi` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indexes for table `puk_program_edit_logs`
--
ALTER TABLE `puk_program_edit_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `puk_program_edit_logs_puk_program_id_foreign` (`puk_program_id`);
...
--
-- Indexes for table `tr_document_histories`
--
ALTER TABLE `tr_document_histories`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tr_document_histories_document_id_foreign` (`document_id`),
  ADD KEY `tr_document_histories_archived_by_foreign` (`archived_by`);
...
--
ALTER TABLE `direktorat`
  MODIFY `id_direktorat` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT for table `puk_program_edit_logs`
--
ALTER TABLE `puk_program_edit_logs`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `tr_document_histories`
--
ALTER TABLE `tr_document_histories`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `puk_program_edit_logs`
--
ALTER TABLE `puk_program_edit_logs`
  ADD CONSTRAINT `puk_program_edit_logs_puk_program_id_foreign` FOREIGN KEY (`puk_program_id`) REFERENCES `puk_programs` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `tr_document_histories`
--
ALTER TABLE `tr_document_histories`
  ADD CONSTRAINT `tr_document_histories_archived_by_foreign` FOREIGN KEY (`archived_by`) REFERENCES `users` (`id_user`) ON DELETE SET NULL,
  ADD CONSTRAINT `tr_document_histories_document_id_foreign` FOREIGN KEY (`document_id`) REFERENCES `documents` (`id`) ON DELETE CASCADE;

...
return new class extends Migration
{
    ...
    {
        Schema::table('puk_programs', function (Blueprint $table) {
            // Add 'revision' to status enum
            DB::statement("ALTER TABLE puk_programs MODIFY COLUMN status ENUM('draft', 'pending_kepala_unit', 'approved', 'rejected', 'revision') DEFAULT 'draft'");
    ...
    public function down(): void
    {
        Schema::table('puk_programs', function (Blueprint $table) {
            // Revert status enum
            DB::statement("ALTER TABLE puk_programs MODIFY COLUMN status ENUM('draft', 'pending_kepala_unit', 'approved', 'rejected') DEFAULT 'draft'");

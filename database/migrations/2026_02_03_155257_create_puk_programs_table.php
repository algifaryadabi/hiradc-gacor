...
return new class extends Migration {
    ...
    {
        Schema::create('puk_programs', function (Blueprint $table) {
            $table->id();
            ...
            // Workflow fields
            $table->enum('status', ['draft', 'pending_kepala_unit', 'approved', 'rejected'])->default('draft');
    ...
    {
        Schema::dropIfExists('puk_programs');
    }
};

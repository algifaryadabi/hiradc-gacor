...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; outline: none; }
        ...
        .btn-approve:hover { background: linear-gradient(135deg, #15803d 0%, #166534 100%); }
                ...
                <table class="hiradc-table">
                   <thead>
                        ...
                        <tr>
                            ...
                            <th style="width: 150px;" class="section-border-right">CELAH (Keamanan)<br><small>(Kol 9)</small></th>
                            ...
                            <th style="width: 200px;" class="section-border-right">Peluang & Risiko<br><small>(Kol 17)</small></th>
                   ...
                   <tbody>
                       ...
                       <tr>
                           ...
                           <td style="text-align:center;">
                               <span style="background:#e0e7ff; color:#3730a3; padding:4px 8px; border-radius:6px; font-size:11px; font-weight:700;">
                                   {{ $item->kategori }}
                               </span>
                           </td>
                           ...
                           <td class="section-border-right" style="text-align:center;">
                               ...
                               <div style="font-size:10px; padding:2px 6px; border-radius:8px; margin-top:4px; font-weight:700; color:white; display:inline-block; {{ $item->kolom14_score >= 15 ? 'background:#dc2626;' : ($item->kolom14_score >= 8 ? 'background:#ca8a04;' : 'background:#16a34a;') }}">
                           ...
                           <td style="text-align:center;">
                               @if($item->kategori == 'Lingkungan' && $item->kolom16_aspek)
                                   <span style="{{ $item->kolom16_aspek == 'P' ? 'background:#dbeafe; color:#1e40af;' : 'background:#f1f5f9; color:#64748b;' }} padding:4px 8px; border-radius:6px; font-size:11px; font-weight:700;">
                                       {{ $item->kolom16_aspek }}
                                   </span>
                               @else
                           ...
                           <td class="section-border-right">
                               ...
                               @if($item->kolom17_peluang)
                                   <div style="margin-top:6px;"><strong>PELUANG (+):</strong> {{ $item->kolom17_peluang }}</div>
                               @endif
                           </td>

                           <!-- BAGIAN 5: Mitigasi Lanjutan -->
                           <td style="text-align:center;">
                               <span style="{{ $item->kolom18_toleransi == 'Ya' ? 'background:#dcfce7; color:#166534;' : 'background:#fee2e2; color:#991b1b;' }} padding:4px 8px; border-radius:6px; font-size:11px; font-weight:700;">
                                   {{ $item->kolom18_toleransi == 'Ya' ? 'Ya' : 'Tidak' }}
                               </span>
                           </td>
                           @if($item->kolom18_toleransi == 'Tidak')
                               <td>{{ $item->kolom19_pengendalian_lanjut }}</td>
                               <td style="text-align:center; font-weight:bold;">{{ $item->kolom20_kemungkinan_lanjut }}</td>
                               <td style="text-align:center; font-weight:bold;">{{ $item->kolom21_konsekuensi_lanjut }}</td>
                               <td style="text-align:center;">
                                   <div style="font-weight:800; font-size:16px;">{{ $item->kolom22_tingkat_risiko_lanjut }}</div>
                                   @if($item->kolom22_tingkat_risiko_lanjut)
                                       <div style="font-size:10px; padding:2px 6px; border-radius:8px; margin-top:4px; font-weight:700; color:white; display:inline-block; {{ $item->kolom22_tingkat_risiko_lanjut >= 15 ? 'background:#dc2626;' : ($item->kolom22_tingkat_risiko_lanjut >= 8 ? 'background:#ca8a04;' : 'background:#16a34a;') }}">

    ...
    <main class="main-content">
        ...
        <div class="stats-grid">
            <div class="stat-card sc-pending">
                ...
                <div>
                    <div class="stat-val" style="font-size:24px; font-weight:800; color:var(--text-main);">
                        {{ collect($documentsData)->count() }}</div>
        ...
        <div class="doc-list" id="docList">
            @forelse($documentsData as $doc)
                <div class="doc-item">
                    ...
                    <div>
                        <div
                            style="font-size:11px; font-weight:700; text-transform:uppercase; color:#3b82f6; margin-bottom:4px;">
                            {{ $doc['unit'] }}
                        </div>
                        <h3 style="font-size:16px; font-weight:700; color:var(--text-main); margin-bottom:4px;">
                            {{ $doc['title'] }}</h3>
            ...
            @empty
                <div
                    style="text-align:center; padding:60px; background:white; border-radius:16px; border:2px dashed var(--border);">

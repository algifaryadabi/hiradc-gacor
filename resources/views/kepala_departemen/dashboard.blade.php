...
<head>
    ...
    <title>Dashboard Kepala Departemen | HIRADC System</title>
...
<body>
    <div class="container">
        ...
        <main class="main-content">
            <div class="header">
                <h1>Dashboard Kepala Departemen</h1>
                ...
                <div class="stats-grid">
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-content">
                            ...
                            <div class="stat-label">Dokumen Published</div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function renderDepartments() {
            ...
            html += '<h3 style="margin-bottom:1.5rem; color:var(--gray-900); font-size:1.25rem; font-weight:700;">Arsip Dokumen Terpublikasi</h3>';
